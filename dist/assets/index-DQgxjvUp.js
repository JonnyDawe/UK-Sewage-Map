...
v3.1.0 */ const o = {
  ...
  s = class s extends c {
    ...
    async back() {
      const { items: e, selectedIndex: t } = this,
        i = e[t],
        a = e[t - 1];
      if (!i || !a) return;
      const n = i.beforeBack ? i.beforeBack : () => Promise.resolve();
      try {
        await n.call(i);
      } catch {
        return;
      }
      return (i.selected = !1), (a.selected = !0), a;
    }
    async setFocus() {
      var t;
      await h(this);
      const { items: e } = this;
      return (t = e[this.selectedIndex]) == null ? void 0 : t.setFocus();
    }
    connectedCallback() {
      var e;
      super.connectedCallback(),
        (e = this.itemMutationObserver) == null ||
          e.observe(this.el, { childList: !0, subtree: !0 });
    }
    willUpdate(e) {
      e.has('flowDirection') &&
    ...
    disconnectedCallback() {
      var e;
      super.disconnectedCallback(), (e = this.itemMutationObserver) == null || e.disconnect();
    }
    async handleFlowDirectionChange(e) {
      e !== 'standby' &&
        (await m(
          this.frameEl,
          e === 'retreating' ? 'calcite-frame-retreat' : 'calcite-frame-advance',
        ),
    ...
    async handleItemBackClick(e) {
      if (!e.defaultPrevented) return await this.back(), this.setFocus();
    }
    resetFlowDirection() {
      this.flowDirection = 'standby';
    }
    getFlowDirection(e, t) {
      const i = e > 0;
      return !(e > -1 && t > 0) && !i ? 'standby' : t < e ? 'retreating' : 'advancing';
    }
    updateItemsAndProps() {
      const { customItemSelectors: e, el: t } = this,
        i = Array.from(t.querySelectorAll(`calcite-flow-item${e ? `,${e}` : ''}`)).filter(
          (a) => a.closest('calcite-flow') === t,
        );
      (this.items = i), this.ensureSelectedFlowItemExists(), this.updateFlowProps();
    }
    updateFlowProps() {
      const { selectedIndex: e, items: t } = this,
        i = this.findSelectedFlowItemIndex(t);
      t.forEach((a, n) => {
        const l = n === i;
        l || (a.menuOpen = !1), (a.showBackButton = l && i > 0);
      }),
        i !== -1 &&
          (e !== i && (this.flowDirection = this.getFlowDirection(e, i)), (this.selectedIndex = i));
    }
    ...
    ensureSelectedFlowItemExists() {
      const { items: e } = this;
      if (this.findSelectedFlowItemIndex(e) !== -1) return;
    ...
    render() {
      const { flowDirection: e } = this,
        t = {
          [o.frame]: !0,
          [o.frameAdvancing]: e === 'advancing',
          [o.frameRetreating]: e === 'retreating',
        };
      return w`<div class=${f(t)} ${u(this.setFrameEl)}><slot></slot></div>`;
    }
  };
(s.properties = { flowDirection: 16, customItemSelectors: 1 }), (s.styles = b);
let r = s;
g('calcite-flow', r);
export { r as Flow };
