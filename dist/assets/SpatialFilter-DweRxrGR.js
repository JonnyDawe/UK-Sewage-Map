...
import { D as se } from './arcade-Cy3NLj9n.js';
import { D as I, n as g, a as m, i as j } from './WhereClause-DynWr3o5.js';
import { a as S } from './operatorsWorkerConnection-Cnsz2hGF.js';
var _;
(function (r) {
  (r.NeverReach = 'NeverReach'),
    (r.NotImplemented = 'NotImplemented'),
    (r.Cancelled = 'Cancelled'),
    (r.InvalidStatResponse = 'InvalidStatResponse'),
    (r.InvalidRequest = 'InvalidRequest'),
    (r.RequestFailed = 'RequestFailed'),
    (r.MissingFeatures = 'MissingFeatures'),
    (r.AggregationFieldNotFound = 'AggregationFieldNotFound'),
    (r.DataElementsNotFound = 'DataElementsNotFound');
})(_ || (_ = {}));
const ie = {
  [_.Cancelled]: 'Cancelled',
  [_.InvalidStatResponse]: 'Invalid statistics response from service',
  [_.InvalidRequest]: 'Invalid request',
  [_.RequestFailed]: 'Request failed - {reason}',
  [_.MissingFeatures]: 'Missing features',
  [_.AggregationFieldNotFound]: 'Aggregation field not found',
  [_.DataElementsNotFound]: 'Data elements not found on service',
  [_.NeverReach]: 'Encountered unreachable logic',
  [_.NotImplemented]: 'Not implemented',
};
class y extends Error {
  constructor(e, t) {
    super(V(ie[e], t)),
      (this.declaredRootClass = 'esri.arcade.featureset.support.featureseterror'),
...
class le {
  ...
  async nextBatchAsArcadeFeatures(e, t) {
    ...
    return n === null
      ? n
      : n.map((a) => se.createFromGraphicLikeObject(a.geometry, a.attributes, this._parent, t));
  }
  nextBatch(e) {
    ...
    const t = { returnpromise: null, hasset: !1 },
      n = [];
    return (
      (t.returnpromise = new Promise((a, s) => {
        this._parent._getSet(this._progress).then(
          (i) => {
            ...
            if (
              ...
              this._lastId + e > u && l.length > 0 && l[l.length - 1] === 'GETPAGES')
            )
              return void this._parent
                ._expandPagedSet(i, this._parent._maxQueryRate(), 0, 0, this._progress)
                .then(
                  (c) => {
                    (t.hasset = !0),
                      (this._parent._mainSetInUse = null),
                      this.nextBatch(e).then(a, s);
                  },
                  (c) => {
            ...
            if (u >= this._lastId + e || o.length === 0) {
              ...
              return (
                ...
                n.length === 0 && ((t.hasset = !0), (this._parent._mainSetInUse = null), a([])),
      ...
      t.hasset === !1 && ((this._parent._mainSetInUse = t.returnpromise), (t.hasset = !0)),
      t.returnpromise
    );
  }
  next() {
    ...
    return (
          ...
          (a) => {
            ...
            this._lastId < s.length - 1
              ? s[this._lastId + 1] === 'GETPAGES'
                ? this._parent
                    ._expandPagedSet(a, this._parent._maxQueryRate(), 0, 0, this._progress)
                    .then(
                      (i) => ((e.hasset = !0), (this._parent._mainSetInUse = null), this.next()),
                    )
                    .then(t, n)
                : ((this._lastId += 1),
                  this._parent._getFeature(a, s[this._lastId], this._progress).then(
                    (i) => {
              ...
              : a._candidates.length > 0
                ? this._parent
                    ._refineSetBlock(a, this._parent._maxProcessingRate(), this._progress)
                    .then(
                      () => {
                        (e.hasset = !0),
                          (this._parent._mainSetInUse = null),
      ...
      e.hasset === !1 && ((this._parent._mainSetInUse = e.returnpromise), (e.hasset = !0)),
      e.returnpromise
    );
  }
  async count() {
  ...
  async _refineAllSets(e) {
    if (e._known.length > 0 && e._known[e._known.length - 1] === 'GETPAGES')
      return (
        await this._parent._expandPagedSet(e, this._parent._maxQueryRate(), 0, 1, this._progress),
        this._refineAllSets(e)
      );
    if (e._candidates.length > 0) {
      if (e._known[e._candidates.length - 1] === 'GETPAGES')
        return (
          await this._parent._expandPagedSet(e, this._parent._maxQueryRate(), 0, 2, this._progress),
          this._refineAllSets(e)
        );
...
function ve(r, e, t, n) {
  const a = d(r.parseTree, h.Standardised, r.parameters, e, t);
  return I.create(a, { fieldsIndex: n, timeZone: r.timeZone, currentUser: r.currentUser });
}
function Re(r, e, t = 'AND') {
  return I.create('((' + q(r, h.Standardised) + ')' + t + '(' + q(e, h.Standardised) + '))', {
...
function d(r, e, t, n = null, a = null) {
  ...
  switch (r.type) {
    case 'interval':
      return pe(d(r.value, e, t, n, a), r.qualifier, r.op);
    case 'case-expression': {
      let o = ' CASE ';
      r.format === 'simple' && (o += d(r.operand, e, t, n, a));
      for (let c = 0; c < r.clauses.length; c++)
        o +=
          ' WHEN ' +
          d(r.clauses[c].operand, e, t, n, a) +
          ' THEN ' +
          d(r.clauses[c].value, e, t, n, a);
      return r.else !== null && (o += ' ELSE ' + d(r.else, e, t, n, a)), (o += ' END '), o;
    }
    case 'parameter': {
      const o = t[r.value.toLowerCase()];
      if (typeof o == 'string')
        return "'" + t[r.value.toLowerCase()].toString().replaceAll("'", "''") + "'";
      if (k(o) || P(o)) return R(o, e);
      if (O(o)) return Q(o, e);
      if (L(o)) return M(o, e);
      if (U(o)) return Y(o, e);
      if (Array.isArray(o)) {
        ...
        for (let p = 0; p < o.length; p++)
          typeof o[p] == 'string'
            ? c.push("'" + o[p].toString().replaceAll("'", "''") + "'")
            : k(o[p]) || P(o[p])
              ? c.push(R(o[p], e))
              : O(o[p])
                ? c.push(Q(o[p], e))
    ...
    case 'expression-list':
      i = [];
      for (const o of r.value) i.push(d(o, e, t, n, a));
      return i;
    ...
    case 'binary-expression':
      switch (r.operator) {
        ...
        case 'IN':
          return (
            (s = []),
            r.right.type === 'expression-list'
              ? ((s = d(r.right, e, t, n, a)),
                ' (' + d(r.left, e, t, n, a) + ' IN (' + s.join(',') + ')) ')
              : ((u = d(r.right, e, t, n, a)),
                Array.isArray(u)
                  ? ' (' + d(r.left, e, t, n, a) + ' IN (' + u.join(',') + ')) '
                  : ' (' + d(r.left, e, t, n, a) + ' IN (' + u + ')) ')
          );
        case 'NOT IN':
          return (
            (s = []),
            r.right.type === 'expression-list'
              ? ((s = d(r.right, e, t, n, a)),
                ' (' + d(r.left, e, t, n, a) + ' NOT IN (' + s.join(',') + ')) ')
              : ((u = d(r.right, e, t, n, a)),
                Array.isArray(u)
                  ? ' (' + d(r.left, e, t, n, a) + ' NOT IN (' + u.join(',') + ')) '
                  : ' (' + d(r.left, e, t, n, a) + ' NOT IN (' + u + ')) ')
          );
        case 'BETWEEN':
          return (
            (l = d(r.right, e, t, n, a)),
            ' (' + d(r.left, e, t, n, a) + ' BETWEEN ' + l[0] + ' AND ' + l[1] + ' ) '
          );
        case 'NOTBETWEEN':
          return (
            (l = d(r.right, e, t, n, a)),
            ' (' + d(r.left, e, t, n, a) + ' NOT BETWEEN ' + l[0] + ' AND ' + l[1] + ' ) '
          );
        case 'LIKE':
          return r.escape !== ''
            ? ' (' +
                ...
                r.escape +
                "') "
            : ' (' + d(r.left, e, t, n, a) + ' LIKE ' + d(r.right, e, t, n, a) + ') ';
        case 'NOT LIKE':
          return r.escape !== ''
            ? ' (' +
                d(r.left, e, t, n, a) +
                ...
                r.escape +
                "') "
            : ' (' + d(r.left, e, t, n, a) + ' NOT LIKE ' + d(r.right, e, t, n, a) + ') ';
        case '<>':
        case '<':
        case '>':
        case '>=':
        ...
        case '/':
          return (
            ' (' + d(r.left, e, t, n, a) + ' ' + r.operator + ' ' + d(r.right, e, t, n, a) + ') '
          );
        case '||':
          return (
            ' (' +
    ...
    case 'column-reference':
      return n && n.toLowerCase() === r.column.toLowerCase() ? '(' + a + ')' : oe(r);
    case 'data-type':
      return r.value;
    case 'function': {
      const o = d(r.args, e, t, n, a);
      return ue(r.name, o, e);
    }
  }
...
function ue(r, e, t) {
  switch (r.toLowerCase().trim()) {
    ...
    case 'abs':
      if (e.length !== 1)
        throw new g(m.InvalidFunctionParameters, { function: r.toLowerCase().trim() });
    ...
    case 'truncate':
      if (e.length < 1 || e.length > 2)
        throw new g(m.InvalidFunctionParameters, { function: 'truncate' });
      return t === h.SqlServer
    ...
    case 'substring': {
      ...
      switch (t) {
        case h.Oracle:
          return (
            (n = 'SUBSTR(' + e[0] + ',' + e[1]), e.length === 3 && (n += ',' + e[2]), (n += ')'), n
          );
        case h.SqlServer:
          return (
            (n =
...
function M(r, e) {
  const t = r.toDateTime(),
    n = t.hour === 0 && t.minute === 0 && t.second === 0 && t.millisecond === 0;
  switch (e) {
    case h.FILEGDB:
    case h.Standardised:
    case h.StandardisedNoInterval:
      return n
        ? `date '${t.toFormat('yyyy-LL-dd')}'`
        : `timestamp '${t.toFormat('yyyy-LL-dd HH:mm:ss')}'`;
    case h.Oracle:
      return n
        ? `TO_DATE('${t.toFormat('yyyy-LL-dd')}','YYYY-MM-DD')`
        : `TO_DATE('${t.toFormat('yyyy-LL-dd HH:mm:ss')}','YYYY-MM-DD HH24:MI:SS')`;
    case h.SqlServer:
...
function Q(r, e) {
  switch ((r instanceof G && (r = r.toStorageString()), e)) {
    case h.Oracle:
...
function R(r, e) {
  return M(X.dateTimeToArcadeDate(P(r) ? r : ee.fromJSDate(r)), e);
}
function ce(r, e) {
  switch (e) {
    case h.FILEGDB:
...
function he(r, e, t = {}) {
  ...
  switch (w(n, r.parseTree, r.parameters, a)) {
    case 'double':
      return 'double';
    case 'integer':
      return 'integer';
...
function w(r, e, t, n) {
  ...
  switch (e.type) {
    ...
    case 'case-expression': {
      const c = [];
      if (e.format === 'simple') {
        for (let p = 0; p < e.clauses.length; p++) c.push(w(r, e.clauses[p].value, t, n));
        e.else !== null && c.push(w(r, e.else, t, n));
      } else {
        for (let p = 0; p < e.clauses.length; p++) c.push(w(r, e.clauses[p].value, t, n));
        e.else !== null && c.push(w(r, e.else, t, n));
      }
    ...
    case 'parameter': {
      ...
      if (c === void 0 && t) {
        ...
        if (typeof p == 'string' || p instanceof String) return 'string';
        if (typeof p == 'boolean') return 'boolean';
        if (k(p) || L(p)) return 'date';
        if (U(p)) return 'date-only';
        if (O(p)) return 'time-only';
        if (typeof p == 'number') return p % 1 == 0 ? 'integer' : 'double';
      }
      return c === void 0 ? '' : c;
    }
    case 'expression-list': {
      const c = [];
      for (const p of e.value) c.push(w(r, p, t, n));
      return c;
    }
    case 'unary-expression':
      return 'boolean';
    case 'binary-expression':
      switch (e.operator) {
        ...
        case '+':
        case '/':
          return C([w(r, e.left, t, n), w(r, e.right, t, n)]);
        case '||':
          return 'string';
        default:
    ...
    case 'function':
      switch (e.name.toLowerCase()) {
        case 'cast':
          switch (
            ((i = (s = e.args) == null ? void 0 : s.value[1]) == null ? void 0 : i.value.type) ??
            ''
          ) {
            case 'integer':
            case 'smallint':
            ...
            case 'timestamp':
              return ((o =
                (u = (l = e.args) == null ? void 0 : l.value[1]) == null ? void 0 : u.value) == null
                ? void 0
                : o.withtimezone) === !0
                ? 'timestamp-offset'
                : 'date';
        ...
        case 'mod':
          return 'integer';
        case 'round':
          if (((a = w(r, e.args, t, n)), Array.isArray(a))) {
        ...
        case 'nullif':
        case 'coalesce':
          return (a = w(r, e.args, t, n)), Array.isArray(a) ? (a.length > 0 ? a[0] : '') : a;
      }
      return '';
  }
  throw new g(m.UnsupportedSyntax, { node: e.type });
}
const K = { boolean: 1, string: 2, integer: 3, double: 4, date: 5 };
function C(r) {
  if (r) {
    let e = '';
    for (const t of r) t !== '' && (e = e === '' || K[e] < K[t] ? t : e);
    return e;
  }
  return '';
}
function Ce(r, e) {
  return T(r.parseTree, e);
}
function de(r) {
...
function T(r, e) {
  ...
  switch (r.type) {
    case 'when-clause':
      return T(r.operand, e) || T(r.value, e);
    case 'case-expression':
      for (const t of r.clauses) if (T(t, e)) return !0;
      return !(r.format !== 'simple' || !T(r.operand, e)) || !(r.else === null || !T(r.else, e));
    case 'parameter':
    case 'null':
    case 'boolean':
    case 'date':
    ...
    case 'number':
      return !1;
    case 'expression-list':
      for (const t of r.value) if (T(t, e)) return !0;
      return !1;
    case 'unary-expression':
      return T(r.expr, e);
    case 'binary-expression':
      return T(r.left, e) || T(r.right, e);
    case 'column-reference':
...
function pe(r, e, t) {
  let n = '';
  return (
    (n = e.type === 'interval-period' ? x(e) : x(e.start) + ' TO ' + x(e.end)),
    'INTERVAL ' + t + ' ' + r + ' ' + n
  );
}
function fe(r) {
...
async function ye(r, e, t) {
  let n = '';
  e && !de(e) && (n = he(e, r.fields));
  const a = await v(r, e, t);
  if (a.length === 0) return null;
  const s = W(a);
  return s === null ? s : n === 'integer' ? fe(s) : s;
}
...
async function we(r, e, t) {
  const n = await v(r, e, t);
  return n.length === 0 ? null : Math.sqrt(z(n));
}
async function Te(r, e, t) {
  const n = await v(r, e, t);
  return n.length === 0 ? null : _e(n);
}
async function Ie(r, e) {
  return r.iterator(e).count();
}
async function v(r, e, t) {
  const n = r.iterator(t),
    a = [],
    s = { ticker: 0 };
  let i = await n.next();
  for (; i !== null; ) {
    if ((s.ticker++, t.aborted)) throw new y(_.Cancelled);
    s.ticker % 100 == 0 &&
      ((s.ticker = 0),
      await new Promise((u) => {
        setTimeout(u, 0);
      }));
    const l = e == null ? void 0 : e.calculateValue(i);
    l === null ||
      (a[a.length] =
        l instanceof $ || l instanceof G ? l.toNumber() : l instanceof j ? l.toMilliseconds() : l),
      (i = await n.next());
  }
  return a;
}
async function Fe(r, e, t = 1e3, n = null) {
  const a = r.iterator(n),
    s = [],
    i = {},
    l = { ticker: 0 };
  let u = await a.next();
  for (; u !== null; ) {
    if ((l.ticker++, n == null ? void 0 : n.aborted)) throw new y(_.Cancelled);
    l.ticker % 100 == 0 &&
      ((l.ticker = 0),
      await new Promise((p) => {
        setTimeout(p, 0);
    ...
    if (
      (o instanceof $
        ? (c = '!!DATEONLY!!-' + o.toString())
        : o instanceof j
          ? (c = '!!TSOFFSETONLY!!-' + o.toString())
          : o instanceof G
            ? (c = '!!TIMEONLY!!-' + o.toString())
            : o instanceof Date && (c = '!!DATE!!-' + o.toString()),
      o != null && i[c] === void 0 && (s.push(o), (i[c] = 1)),
      s.length >= t && t !== -1)
    )
      return s;
    u = await a.next();
...
class f {
  constructor(e) {
    (this.recentlyUsedQueries = null),
      ...
      (this.fsetInfo = null),
      e != null && e.lrucache && (this.recentlyUsedQueries = e.lrucache),
      e != null && e.interceptor && (this.featureSetQueryInterceptor = e.interceptor);
  }
  ...
  _initialiseFeatureSet() {
    this._parent !== null
      ...
      : ((this.fields = []),
        ...
        (this.objectIdField = ''),
        (this.globalIdField = ''),
        (this.spatialReference = new te({ wkid: 4326 })),
  ...
  getField(e, t) {
    ...
    return (
      (t = t || this.fields) &&
        ((e = e.toLowerCase()), t.some((a) => (a && a.name.toLowerCase() === e && (n = a), !!n))),
      n
    );
  }
  getFieldsIndex() {
    return (
      this._fieldsIndex === null &&
        (this._fieldsIndex = ae.fromLayer({
  ...
  async databaseType() {
    if (this._databaseType === h.NotEvaluated) {
      if (N.applicationCache !== null) {
        const e = N.applicationCache.getDatabaseType(this._cacheableFeatureSetSourceKey());
        if (e !== null) return e;
      }
      ...
      try {
        (this._databaseTypeProbed = this._getDatabaseTypeImpl()),
          N.applicationCache !== null &&
            N.applicationCache.setDatabaseType(
        ...
        throw (
          (N.applicationCache !== null &&
            N.applicationCache.clearDatabaseType(this._cacheableFeatureSetSourceKey()),
          e)
        );
      }
  ...
  async _getDatabaseTypeImpl() {
    const e = [
      ...
      {
        thetype: h.StandardisedNoInterval,
        testwhere: "(date '2015-01-01 10:10:10' = date '2015-01-01 10:10:10') AND OBJECTID<0",
      },
    ];
    for (const t of e) if ((await this._runDatabaseProbe(t.testwhere)) === !0) return t.thetype;
  ...
  async _refineSetBlock(e, t, n) {
    if (this._checkIfNeedToExpandCandidatePage(e, this._maxQueryRate()) === !0)
      return (
        await this._expandPagedSet(e, this._maxQueryRate(), 0, 0, n), this._refineSetBlock(e, t, n)
      );
    this._checkCancelled(n);
    ...
    if (
      ...
      (s = a - e._candidates.length),
      s < t && e._candidates.length > 0)
    ) {
      const i = t - s,
        l = this._prepareFetchAndRefineSet(e._candidates);
      return (
        await this._fetchAndRefineFeatures(l, l.length > i ? i : e._candidates.length, n),
        this._checkCancelled(n),
        this._refineKnowns(e, t - s),
        e
      );
  ...
  async _expandPagedSetFeatureSet(e, t, n, a, s) {
    if (
      (e._known.length > 0 && e._known[e._known.length - 1] === 'GETPAGES' && (a = 1),
      a === 0 &&
  ...
  async _getPage(e, t, n) {
    ...
    if (
      ...
      for (
        ...
        !(e.pagesDefinition.resultOffset + l >= e.pagesDefinition.internal.set.length);
        l++
      )
  ...
  async _manualStat(e, t, n, a) {
    ...
    switch (e.toLowerCase()) {
      case 'count':
        return (s = await Ie(this, a)), { calculated: !0, result: s };
      case 'distinct':
        return (s = await Fe(this, t, n, a)), { calculated: !0, result: s };
      case 'avg':
      case 'mean':
        return (s = await ye(this, t, a)), { calculated: !0, result: s };
      case 'stdev':
        return (s = await we(this, t, a)), { calculated: !0, result: s };
      case 'variance':
        return (s = await Se(this, t, a)), { calculated: !0, result: s };
      case 'sum':
        return (s = await Te(this, t, a)), { calculated: !0, result: s };
      case 'min':
        return (s = await ge(this, t, a)), { calculated: !0, result: s };
      case 'max':
        return (s = await me(this, t, a)), { calculated: !0, result: s };
      default:
      ...
      try {
        s !== null && s.geometry !== null && e.push(s.geometry),
          e.length > 30 || (s === null && e.length > 1)
            ? S('union', [e.map((i) => i.toJSON())]).then((i) => {
                try {
                  s === null ? n(i) : ((e = [re(i)]), this._unionShapeInBatches(e, t, n, a));
                } catch (l) {
                  a(l);
                }
              }, a)
            : s === null
              ? e.length === 1
                ? n(e[0])
                : n(null)
              : this._unionShapeInBatches(e, t, n, a);
      } catch (i) {
        a(i);
      }
    }, a);
  ...
  intersection(e, t = !1) {
    return f._featuresetFunctions.intersection.bind(this)(e, t);
  }
  difference(e, t = !1, n = !0) {
    return f._featuresetFunctions.difference.bind(this)(e, t, n);
  }
  symmetricDifference(e, t = !1, n = !0) {
    return f._featuresetFunctions.symmetricDifference.bind(this)(e, t, n);
  }
  morphShape(e, t, n = 'unknown', a = null) {
    return f._featuresetFunctions.morphShape.bind(this)(e, t, n, a);
  }
  morphShapeAndAttributes(e, t, n = 'unknown') {
    return f._featuresetFunctions.morphShapeAndAttributes.bind(this)(e, t, n);
  }
  union(e, t = !1) {
    return f._featuresetFunctions.union.bind(this)(e, t);
  }
  intersects(e) {
    return f._featuresetFunctions.intersects.bind(this)(e);
  }
  envelopeIntersects(e) {
    return f._featuresetFunctions.envelopeIntersects.bind(this)(e);
  }
  contains(e) {
    return f._featuresetFunctions.contains.bind(this)(e);
  }
  overlaps(e) {
    return f._featuresetFunctions.overlaps.bind(this)(e);
  }
  relate(e, t) {
    return f._featuresetFunctions.relate.bind(this)(e, t);
  }
  within(e) {
    return f._featuresetFunctions.within.bind(this)(e);
  }
  touches(e) {
    return f._featuresetFunctions.touches.bind(this)(e);
  }
  top(e) {
    return f._featuresetFunctions.top.bind(this)(e);
  }
  crosses(e) {
    return f._featuresetFunctions.crosses.bind(this)(e);
  }
  buffer(e, t, n, a = !0) {
    return f._featuresetFunctions.buffer.bind(this)(e, t, n, a);
  }
  filter(e, t = null) {
    return f._featuresetFunctions.filter.bind(this)(e, t);
  }
  orderBy(e) {
    return f._featuresetFunctions.orderBy.bind(this)(e);
  }
  dissolve(e, t) {
    return f._featuresetFunctions.dissolve.bind(this)(e, t);
  }
  groupby(e, t) {
    return f._featuresetFunctions.groupby.bind(this)(e, t);
  }
  reduce(e, t = null, n) {
    return new Promise((a, s) => {
        ...
        try {
          if (u === null) s(n);
            ...
            B(o)
              ...
              : this._reduceImpl(e, t, o, a + 1, s, i, l);
          }
        } catch (o) {
          i(o);
        }
  ...
  removeField(e) {
    return f._featuresetFunctions.removeField.bind(this)(e);
  }
  addField(e, t, n = null) {
    return f._featuresetFunctions.addField.bind(this)(e, t, n);
  }
  async sumArea(e, t = !1, n) {
    const a = this.iterator(n);
    let s,
      i = 0;
    for (; (s = await a.next()) != null; )
      s.geometry != null &&
        (i += t
          ? await S('geodeticArea', [s.geometry.toJSON(), e])
          : await S('area', [s.geometry.toJSON(), e]));
    return i;
  }
  async sumLength(e, t = !1, n) {
    ...
    for (; (s = await a.next()) != null; )
      s.geometry != null &&
        (i += t
          ? await S('geodeticLength', [s.geometry.toJSON(), e])
          : await S('length', [s.geometry.toJSON(), e]));
    return i;
  }
  async distinct(e, t = 1e3, n = null, a) {
    ...
    return A(s, n), this.calculateStatistic('distinct', s, t, this._defaultTracker(a));
  }
  async min(e, t = null, n) {
    ...
    return A(a, t), this.calculateStatistic('min', a, -1, this._defaultTracker(n));
  }
  async max(e, t = null, n) {
    ...
    return A(a, t), this.calculateStatistic('max', a, -1, this._defaultTracker(n));
  }
  async avg(e, t = null, n) {
    ...
    return A(a, t), this.calculateStatistic('avg', a, -1, this._defaultTracker(n));
  }
  async sum(e, t = null, n) {
    ...
    return A(a, t), this.calculateStatistic('sum', a, -1, this._defaultTracker(n));
  }
  async stdev(e, t = null, n) {
    ...
    return A(a, t), this.calculateStatistic('stdev', a, -1, this._defaultTracker(n));
  }
  async variance(e, t = null, n) {
    ...
    return A(a, t), this.calculateStatistic('variance', a, -1, this._defaultTracker(n));
  }
  async count(e) {
    return (
      await this.load(),
  ...
  convertToJSON(e) {
    ...
    for (let n = 0; n < this.fields.length; n++) t.layerDefinition.fields.push(J(this.fields[n]));
    return this.reduce(
      (n, a) => {
        var i;
        const s = { geometry: (i = a.geometry) == null ? void 0 : i.toJSON(), attributes: {} };
        for (const l in a.attributes) s.attributes[l] = a.attributes[l];
  ...
  subtypeMetaData() {
    return this.subtypeField && this.subtypes
      ? {
          ...
          subtypes: this.subtypes ? this.subtypes.map((e) => ({ name: e.name, code: e.code })) : [],
        }
      : this.typeIdField
        ? {
            subtypeField: this.typeIdField,
            subtypes: this.types ? this.types.map((e) => ({ name: e.name, code: e.id })) : [],
          }
        : null;
  }
  ...
  schema() {
    const e = [];
    for (const t of this.fields) e.push(J(t));
    return {
      objectIdField: this.objectIdField,
      globalIdField: this.globalIdField,
      geometryType: Z[this.geometryType] === void 0 ? 'esriGeometryNull' : Z[this.geometryType],
      fields: e,
    };
  }
  async convertToText(e, t) {
    ...
    if (e === 'featureset') {
      ...
      const a = this.schema();
      return (
        (a.features = n), (a.spatialReference = this.spatialReference.toJSON()), JSON.stringify(a)
      );
    }
  ...
  async getFeatureSetInfo() {
    var e;
    return (
      this.fsetInfo ?? (await ((e = this._parent) == null ? void 0 : e.getFeatureSetInfo())) ?? null
    );
  }
}
function A(r, e) {
...
class F extends f {
  ...
  async executeSpatialRelationTest(e) {
    ...
    switch (this._relation) {
      case 'esriSpatialRelEnvelopeIntersects': {
        const t = H(this._relationGeom),
          n = H(e.geometry);
        return t != null && n != null && S('intersects', [t.toJSON(), n.toJSON()]);
      }
      case 'esriSpatialRelIntersects':
        return S('intersects', [this._relationGeom.toJSON(), e.geometry.toJSON()]);
      case 'esriSpatialRelContains':
        return S('contains', [this._relationGeom.toJSON(), e.geometry.toJSON()]);
      case 'esriSpatialRelOverlaps':
        return S('overlaps', [this._relationGeom.toJSON(), e.geometry.toJSON()]);
      case 'esriSpatialRelWithin':
        return S('within', [this._relationGeom.toJSON(), e.geometry.toJSON()]);
      case 'esriSpatialRelTouches':
        return S('touches', [this._relationGeom.toJSON(), e.geometry.toJSON()]);
      case 'esriSpatialRelCrosses':
        return S('crosses', [this._relationGeom.toJSON(), e.geometry.toJSON()]);
  ...
  async _fetchAndRefineFeatures(e, t, n) {
    var l;
    const a = new D([], e, !1, null),
      s = Math.min(t, e.length);
    await ((l = this._parent) == null ? void 0 : l._getFeatures(a, -1, s, n)),
      this._checkCancelled(n);
    const i = [];
    for (let u = 0; u < s; u++) {
  ...
  async _getFilteredSet(e, t, n, a, s) {
    ...
    return (
      ...
      (l =
        t !== null
          ? new D(
              i._candidates.slice().concat(i._known.slice()),
              [],
              i._ordered,
  ...
  static registerAction() {
    (f._featuresetFunctions.intersects = function (e) {
      return e == null
        ? new E({ parentfeatureset: this })
        : new F({ parentfeatureset: this, relation: 'esriSpatialRelIntersects', relationGeom: e });
    }),
      (f._featuresetFunctions.envelopeIntersects = function (e) {
        return e == null
          ? new E({ parentfeatureset: this })
          : new F({
      ...
      (f._featuresetFunctions.contains = function (e) {
        return e == null
          ? new E({ parentfeatureset: this })
          : new F({ parentfeatureset: this, relation: 'esriSpatialRelContains', relationGeom: e });
      }),
      (f._featuresetFunctions.overlaps = function (e) {
        return e == null
          ? new E({ parentfeatureset: this })
          : new F({ parentfeatureset: this, relation: 'esriSpatialRelOverlaps', relationGeom: e });
      }),
      (f._featuresetFunctions.within = function (e) {
        return e == null
          ? new E({ parentfeatureset: this })
          : new F({ parentfeatureset: this, relation: 'esriSpatialRelWithin', relationGeom: e });
      }),
      (f._featuresetFunctions.touches = function (e) {
        return e == null
          ? new E({ parentfeatureset: this })
          : new F({ parentfeatureset: this, relation: 'esriSpatialRelTouches', relationGeom: e });
      }),
      (f._featuresetFunctions.crosses = function (e) {
        return e == null
          ? new E({ parentfeatureset: this })
          : new F({ parentfeatureset: this, relation: 'esriSpatialRelCrosses', relationGeom: e });
      }),
      (f._featuresetFunctions.relate = function (e, t) {
        return e == null
          ? new E({ parentfeatureset: this })
          : new F({
              parentfeatureset: this,
