const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/VideoController-DFzpRbZD.js',
      ...
      'assets/mediaLayerUtils--VokKTXe.js',
      ...
      'assets/resourceUtils-DPD9T3VH.js',
      'assets/resourceUtils-CbwzjbCR.js',
    ]),
) => i.map((i) => d[i]);
import { _ as be } from './index-DqxZnyqH.js';
import {
  bF as _e,
  dl as D,
  a8 as W,
...
import {
  ...
  m as xt,
  c as oe,
} from './MediaElementView-BZRiYSif.js';
import { t as Rt, e as re } from './mat3f64-q3fE-ZOt.js';
import { p as bt } from './resourceExtension-DaIfonE_.js';
import { o as _t } from './BoundsStore-BGfZSiDX.js';
      ...
      typeof t == 'string'
        ? this.addResolvingPromise(
            Promise.all([
              ...
              be(
                () => import('./VideoController-DFzpRbZD.js').then((o) => o.V),
    ...
    super(e),
      ...
      (this._debouncedSaveOperations = yt(async (t, o, n) => {
        const { save: r, saveAs: i } = await be(
          () => import('./mediaLayerUtils--VokKTXe.js'),
