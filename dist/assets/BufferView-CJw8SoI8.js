import { kf as G, d0 as H, at as _ } from './index.lazy-BFilFZ3v.js';
let j = class {
  constructor(e, t, s = 0, r, i) {
    ...
    (this.typedBuffer = i == null ? new f(t, u) : new f(t, u, (i - s) / f.BYTES_PER_ELEMENT)),
      (this.typedBufferStride = r / f.BYTES_PER_ELEMENT),
      (this.count = Math.ceil(this.typedBuffer.length / this.typedBufferStride)),
      (this.stride = this.typedBufferStride * this.TypedArrayConstructor.BYTES_PER_ELEMENT);
  }
  ...
  copyFrom(e, t, s) {
    const r = this.typedBuffer,
      i = t.typedBuffer;
    let f = e * this.typedBufferStride,
      u = s * t.typedBufferStride;
...
let c = class {
  ...
  getVec(e, t) {
    return (
      ...
      H(t, this.typedBuffer[e], this.typedBuffer[e + 1], this.typedBuffer[e + 2])
    );
  }
  setVec(e, t) {
    (e *= this.typedBufferStride),
...
class h {
  ...
  getVec(e, t) {
    return (
      (e *= this.typedBufferStride),
      _(t, this.typedBuffer[e++], this.typedBuffer[e++], this.typedBuffer[e++], this.typedBuffer[e])
    );
  }
  setVec(e, t) {
    (e *= this.typedBufferStride),
