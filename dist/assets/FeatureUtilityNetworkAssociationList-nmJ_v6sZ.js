const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      'assets/index-DkYaZPPY.js',
      'assets/index-CcoBvLke.js',
      'assets/customElement-qhwLU-ok.js',
      'assets/escapeRegExp-CEZwNgWI.js',
      'assets/utils-DBnkUeOL.js',
      'assets/index-CPpOQ1Ks.js',
...
import { _ as u } from './index-DqxZnyqH.js';
import {
  ms as V,
  c0 as O,
  mt as y,
...
let l = class extends V {
  ...
  loadDependencies() {
    return L({
      ...
      loader: () =>
        u(
          () => import('./index.lazy-BHTpPf8X.js').then((e) => e.wd),
          __vite__mapDeps([0, 1, 2, 3]),
        ),
      notice: () => u(() => import('./index-CaSeDxS5.js'), __vite__mapDeps([7, 0, 1, 2, 3])),
    });
  }
  destroy() {
...
let c = (w = class extends x {
  ...
  loadDependencies() {
    return L({
      chip: () => u(() => import('./index-DkYaZPPY.js'), __vite__mapDeps([8, 0, 1, 2, 3, 6])),
      icon: () =>
        u(
          () => import('./index.lazy-BHTpPf8X.js').then((e) => e.we),
          __vite__mapDeps([0, 1, 2, 3]),
  ...
  async _selectAssociation(e) {
    ...
    const { default: i } = await u(
      () => import('./index.lazy-BHTpPf8X.js').then((n) => n.wb),
      __vite__mapDeps([0, 1, 2, 3]),
    );
    t.push(
