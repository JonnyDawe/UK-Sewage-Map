  ...
  e = class e extends l {
    constructor() {
      super(),
        ...
        (this.layout = 'default'),
        (this.scale = 'm'),
        (this.calciteInternalLabelClick = n({ bubbles: !1, cancelable: !1 })),
    ...
    disconnectedCallback() {
      super.disconnectedCallback(), document.dispatchEvent(new CustomEvent(o));
    }
    labelClickHandler(t) {
      var i;
      ((i = window.getSelection()) == null ? void 0 : i.type) !== 'Range' &&
        this.calciteInternalLabelClick.emit({ sourceEvent: t });
    }
    render() {
      return d`<div class=${r(m.container)}><slot></slot></div>`;
    }
  };
(e.properties = { alignment: 3, for: 3, layout: 3, scale: 3 }), (e.styles = p);
let a = e;
b('calcite-label', a);
export { a as Label };
