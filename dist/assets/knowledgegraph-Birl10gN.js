const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/knowledgeGraphService-D6eimUXx.js',
...
import { a as u, r as l } from './unitConversion-B9NexLEg.js';
import { l as tt } from './portalUtils-BJ4wJHK1.js';
import { c as nt, t as et, p as at, a as rt } from './Path-CTKxwy0k.js';
import { p as it } from './GraphQueryStreaming-Cu8j5dMv.js';
...
async function F(t, n) {
  ...
  return (
    ...
    f === null &&
      (f = await G(
        () => import('./knowledgeGraphService-D6eimUXx.js').then((i) => i.k),
  ...
  t.mode === 'async' &&
    ...
    (t.functions.querygraph = function (n, a) {
      return t.standardFunctionAsync(n, a, async (i, s, e) => {
        ...
        f === null &&
          (f = await G(
            () => import('./knowledgeGraphService-D6eimUXx.js').then((o) => o.k),
            __vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7]),
          ));
        let d = null;
        const p = X(e[2], null);
