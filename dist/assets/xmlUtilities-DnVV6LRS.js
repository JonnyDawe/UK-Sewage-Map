...
import { j as et, n as tt, m as it, _ as nt, a as rt } from './RasterSymbolizer-DYFNZRYd.js';
import { _ as st } from './index-DShQM7Xx.js';
import { QueueProcessor as at } from './QueueProcessor-ErTuyLry.js';
import { i as he, m as de, h as fe, x as ot, s as lt } from './RawBlockCache-zzhaWOD6.js';
import {
  U as Z,
  D as ve,
  R as ct,
...
import {
  ...
  z as gt,
  Z as ie,
} from './rasterProjectionHelper-DJtrOMxZ.js';
import { h as ne, l as Rt, T as bt } from './rasterFunctionHelper-DliCv-Og.js';
const ye = 8,
  It = 256;
let wt = 0,
  v = class extends ke {
    ...
    if (i && t.clippingType === 'inside') {
      const { extent: s } = this.rasterInfo,
        { difference: e, densify: n } = await st(
          async () => {
            const { difference: r, densify: o } = await import('./geometryEngine-Bbu98ZOV.js');
