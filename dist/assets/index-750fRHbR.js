  ...
  l = class l extends k {
    constructor() {
      super(),
        ...
        (this.calciteDropdownItemSelect = s({ cancelable: !1 })),
        (this.calciteInternalDropdownCloseRequest = s({ cancelable: !1 })),
        (this.calciteInternalDropdownItemKeyEvent = s({ cancelable: !1 })),
        (this.calciteInternalDropdownItemSelect = s({ cancelable: !1 })),
    ...
    async setFocus() {
      var e;
      await D(this), (e = this.el) == null || e.focus();
    }
    connectedCallback() {
    ...
    updateActiveItemOnChange(e) {
      e.composedPath().includes(this.parentDropdownGroupEl) &&
    ...
    initialize() {
      (this.parentDropdownGroupEl = this.el.closest('calcite-dropdown-group')),
        this.selectionMode === 'none' && (this.selected = !1);
    }
    determineActiveItem() {
      switch (this.selectionMode) {
        case 'multiple':
          ...
          break;
        case 'single':
          this.el === this.requestedDropdownItem
            ? (this.selected = !0)
            : this.requestedDropdownGroup === this.parentDropdownGroupEl && (this.selected = !1);
          break;
        case 'none':
          this.selected = !1;
          break;
    ...
    render() {
      const { href: e, selectionMode: o, label: h, iconFlipRtl: c } = this,
        m = n`<calcite-icon class=${i(t.iconStart)} .flipRtl=${c === 'start' || c === 'both'} .icon=${this.iconStart} .scale=${r(this.scale)}></calcite-icon>`,
        a = n`<span class=${i(t.itemContent)}><slot></slot></span>`,
        u = n`<calcite-icon class=${i(t.iconEnd)} .flipRtl=${c === 'end' || c === 'both'} .icon=${this.iconEnd} .scale=${r(this.scale)}></calcite-icon>`,
        w =
          this.iconStart && this.iconEnd
            ...
            : this.iconStart
              ...
              : this.iconEnd
                ...
                : a,
        b = e
          ? n`<a .ariaLabel=${h} class=${i(t.link)} href=${e ?? d} rel=${this.rel ?? d} tabindex=-1 target=${this.target ?? d} ${y(this.childLink)}>${w}</a>`
          : w,
        f = e
          ? null
          : o === 'single'
            ...
            : o === 'multiple'
              ? 'menuitemcheckbox'
              : 'menuitem',
        g = o !== 'none' ? $(this.selected) : null,
        { disabled: v } = this;
      return (
        (this.el.ariaChecked = g),
        (this.el.ariaLabel = e ? '' : h),
        (this.el.role = f),
        q(this.el, 'tabIndex', v ? -1 : 0),
        E({
          disabled: v,
          children: n`<div class=${i({ [t.container]: !0, [t.containerNone]: o === 'none' })}>${o !== 'none' ? n`<calcite-icon class=${i(t.icon)} .icon=${o === 'multiple' ? 'check' : 'bullet-point'} .scale=${r(this.scale)}></calcite-icon>` : null}${b}</div>`,
        })
      );
    }
  };
(l.properties = {
  ...
  (l.styles = R);
let p = l;
z('calcite-dropdown-item', p);
export { p as DropdownItem };
