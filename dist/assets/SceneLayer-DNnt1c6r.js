...
import { _ as q } from './index-DqxZnyqH.js';
import {
  A as s,
  B as a,
  kO as G,
...
import { i as Be, m as Ze, a as Xe } from './meshSpatialReferenceScaleUtils-C3s3_KiX.js';
import { R as Ye, V as W } from './SceneService-DxlCuRp2.js';
import { s as et } from './associatedFeatureServiceUtils-Diwht1Ig.js';
import { t as tt } from './capabilities-B4c8vV3b.js';
import { p as ee, a as rt, y as st, m as it } from './I3SLayerDefinitions-DXSKnRbZ.js';
import { a as at } from './lazyLayerLoader-Bm2EImkh.js';
import { v as ot } from './persistable-BzqtFNgb.js';
import { $ as B, P as nt, w as lt } from './elevationInfoUtils-BlCBaVBo.js';
import { V as dt } from './I3SUtil-BU9ujABi.js';
import { n as pt, p as ut } from './popupUtils-DSw4WkC7.js';
...
let o = class extends ct(pe(Ye(ue(ce(ye(he(fe(me(ge(we.ClonableMixin(ve))))))))))) {
  ...
  async applyEdits(e, r) {
    const { applyEdits: t } = await q(
      () => import('./editingSupport-DdXJgLus.js'),
  ...
  async convertMesh(e, r) {
    ...
    const l = this.spatialReference,
      ...
      { default: y } = await q(
        async () => {
          const { default: c } = await import('./Mesh-DyPbeJ-H.js');
          return { default: c };
        },
        __vite__mapDeps([
