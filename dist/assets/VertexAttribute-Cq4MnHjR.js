...
(function (E) {
  (E.POSITION = 'position'),
    ...
    (E.TANGENT = 'tangent'),
    (E.OFFSET = 'offset'),
    (E.PERSPECTIVEDIVIDE = 'perspectiveDivide'),
    (E.CENTEROFFSETANDDISTANCE = 'centerOffsetAndDistance'),
    (E.LENGTH = 'length'),
    (E.PREVPOSITION = 'prevPosition'),
    ...
    (E.INSTANCEMODELORIGINHI = 'instanceModelOriginHi'),
    (E.INSTANCEMODELORIGINLO = 'instanceModelOriginLo'),
    (E.INSTANCEMODEL = 'instanceModel'),
    (E.INSTANCEMODELNORMAL = 'instanceModelNormal'),
    ...
    (E.NORMAL2COMPRESSED = 'normal2Compressed'),
    ...
    (E.INSTANCEOBJECTANDLAYERIDCOLOR = 'instanceObjectAndLayerIdColor');
})(T || (T = {}));
export { O as E, T as e };
