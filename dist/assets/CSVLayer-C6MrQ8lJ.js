...
let n = class extends v {
  constructor(e) {
    super(e),
      (this.type = 'csv'),
      (this.refresh = w(async (t) => {
        await this.load();
        const { extent: o, timeExtent: a } = await this._connection.invoke('refresh', t);
        return (
          o && (this.sourceJSON.extent = o),
          a && (this.sourceJSON.timeInfo.timeExtent = [a.start, a.end]),
          {
            dataChanged: !0,
            updates: { extent: this.sourceJSON.extent, timeInfo: this.sourceJSON.timeInfo },
          }
        );
      }));
  }
  ...
  async queryFeatureCount(e, t = {}) {
    return (
      await this.load(t), this._connection.invoke('queryFeatureCount', e ? e.toJSON() : null, t)
    );
  }
  ...
  async queryExtent(e, t = {}) {
    ...
    return { count: o.count, extent: O.fromJSON(o.extent) };
  }
  ...
  async queryAttributeBins(e, t = {}) {
    return (
      await this.load(), this._connection.invoke('queryAttributeBins', e ? e.toJSON() : null, t)
    );
  }
  async _startWorker(e) {
    this._connection = await F('CSVSourceWorker', {
      strategy: b('feature-layers-workers') ? 'dedicated' : 'local',
      signal: e,
      registryTarget: this,
    });
    const {
      ...
      c = await this._connection.invoke(
        'load',
        {
          ...
          parsingOptions: {
            delimiter: o,
            fields: a == null ? void 0 : a.map((g) => g.toJSON()),
            latitudeField: f,
            longitudeField: m,
...
let s = class extends I {
  ...
  load(e) {
    const t = e != null ? e.signal : null,
      o = this.loadFromPortal({ supportedTypes: ['CSV'], supportsData: !1 }, e)
        .catch(_)
        .then(async () => this.initLayerProperties(await this.createGraphicsSource(t)));
  ...
  readWebMapLabelsVisible(e, t) {
    ...
    return t.showLabels != null
      ? t.showLabels
      : !!(
          (a = (o = t.layerDefinition) == null ? void 0 : o.drawingInfo) != null && a.labelingInfo
        );
  }
  set url(e) {
    ...
    this._set('url', t.path),
      t.query && (this.customParameters = { ...this.customParameters, ...t.query });
  }
  ...
  queryFeatures(e, t) {
    return this.load()
      ...
      .then((o) => {
        if (o != null && o.features) for (const a of o.features) a.layer = a.sourceLayer = this;
        return o;
      });
  }
  async queryObjectIds(e, t) {
    return await this.load(), this.source.queryObjectIds(l.from(e) || this.createQuery());
  }
  ...
  read(e, t) {
    super.read(e, t),
      t && t.origin === 'service' && this.revert(['latitudeField', 'longitudeField'], 'service');
  }
  write(e, t) {
...
i([r({ readOnly: !0, json: { read: !1, write: !1 } })], s.prototype, 'capabilities', void 0),
  i(
    [
      r({
        type: [',', ' ', ';', '|', '	'],
  ...
  i([r({ type: Boolean, readOnly: !0 })], s.prototype, 'isTable', null),
  i(
    [P('web-map', 'labelsVisible', ['layerDefinition.drawingInfo.labelingInfo', 'showLabels'])],
    s.prototype,
    ...
    [
      r({
        ...
        json: {
          ...
          write: { target: 'locationInfo.locationType', ignoreOrigin: !0, isRequired: !0 },
        },
      }),
    ],
    s.prototype,
    ...
    [
      r({
        ...
        json: {
          ...
          write: { target: 'locationInfo.longitudeFieldName', ignoreOrigin: !0 },
        },
      }),
    ],
    s.prototype,
  ...
  i([r({ type: ['CSV'] })], s.prototype, 'operationalLayerType', void 0),
  i([r()], s.prototype, 'outFields', void 0),
  i(
    [
      r({
        type: String,
        json: { origins: { 'web-scene': { read: !1, write: !1 } }, read: !1, write: !1 },
      }),
    ],
    s.prototype,
    'path',
  ...
  i([r({ json: { read: !1 }, cast: null, type: n, readOnly: !0 })], s.prototype, 'source', void 0),
  i([r({ json: { read: !1 }, value: 'csv', readOnly: !0 })], s.prototype, 'type', void 0),
  i(
    [r({ json: { read: C, write: { isRequired: !0, ignoreOrigin: !0, writer: j } } })],
    s.prototype,
    'url',
    null,
  ),
  (s = i([y('esri.layers.CSVLayer')], s));
const L = s;
export { L as default };
