const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/loadGLTFMesh-C8jCQVEB.js',
      ...
      'assets/gltfexport-Cp7DG2WL.js',
    ]),
) => i.map((i) => d[i]);
import { _ as ie } from './index-DqxZnyqH.js';
import {
  a7 as te,
  eb as it,
  a8 as ne,
...
import { z as Te, w as Q, k as Be, j as je, d as Tt } from './axisAngleDegrees-CyDyao6S.js';
import { f as U } from './MeshComponent-EHsts0H0.js';
import { a as fe, n as Z } from './MeshLocalVertexSpace-cTk7IO-v.js';
import { N as V } from './MeshTransform-B6wPxgq-.js';
import { p as J } from './MeshVertexAttributes-DQWxSiHS.js';
import { t as K, l as Y, c as Ie, u as Bt } from './meshVertexSpaceUtils-BhxP4Ndr.js';
import { f as jt } from './triangulationUtils-rZ1X1HtS.js';
import { c as M } from './projectPointToVector-BJ7KR9p7.js';
import {
  F as v,
  B as he,
  O as E,
...
import { a as de } from './spatialReferenceEllipsoidUtils-Dh_5G9X2.js';
import { m as We } from './computeTranslationToOriginAndRotation-DHcz8NsR.js';
import { r as ve, a as Ut } from './vec3-DUd4WD2P.js';
import { o as ye, h as kt, m as Gt } from './External-CgGCgwxl.js';
import { e as He } from './mat3f64-q3fE-ZOt.js';
import { b as Nt } from './quat-DoRHSg5X.js';
...
async function sn(e, t, n) {
  const { source: r } = t,
    { loadGLTFMesh: s } = await Fe(
      ie(
        () => import('./loadGLTFMesh-C8jCQVEB.js'),
        __vite__mapDeps([
