import { c as s } from './UpdateTracking2D-DyH6ccIi.js';
import { eD as o } from './index.lazy-BHTpPf8X.js';
class g {
  constructor() {
  ...
  async fetchResource(e, r) {
    ...
    return i
      ? i.then((t) => ({ width: t.width, height: t.height }))
      : ((i = o(e, r)),
        this._inFlightResourceMap.set(e, i),
        i.then(
          (t) => (
            this._inFlightResourceMap.delete(e),
            this._resourceMap.set(e, t),
