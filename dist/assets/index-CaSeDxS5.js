...
/*! All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://github.com/Esri/calcite-design-system/blob/dev/LICENSE.md for details.
v3.1.0 */ const n = { title: 'title', message: 'message', link: 'link', actionsEnd: 'actions-end' },
  o = {
  ...
  c = class c extends g {
    constructor() {
      super(...arguments),
        ...
        (this.scale = 'm'),
        (this.width = 'auto'),
        (this.calciteNoticeBeforeClose = i({ cancelable: !1 })),
        (this.calciteNoticeBeforeOpen = i({ cancelable: !1 })),
        (this.calciteNoticeClose = i({ cancelable: !1 })),
        (this.calciteNoticeOpen = i({ cancelable: !1 }));
    }
    async setFocus() {
      await u(this);
    ...
    async load() {
      this.requestedIcon = l(h, this.icon, this.kind);
    }
    willUpdate(t) {
      t.has('open') && (this.hasUpdated || this.open !== !1) && b(this),
        (t.has('icon') || (t.has('kind') && (this.hasUpdated || this.kind !== 'brand'))) &&
          (this.requestedIcon = l(h, this.icon, this.kind));
    }
    onBeforeClose() {
    ...
    handleActionsEndSlotChange(t) {
      this.hasActionEnd = v(t);
    }
    render() {
      const t = a`<button .ariaLabel=${this.messages.close} class=${e(o.close)} @click=${this.close} ${r(this.closeButton)}><calcite-icon icon=x .scale=${d(this.scale)}></calcite-icon></button>`;
      return a`<div class=${e(o.container)} ${r(this.setTransitionEl)}>${this.requestedIcon ? a`<div class=${e(o.icon)}><calcite-icon .flipRtl=${this.iconFlipRtl} .icon=${this.requestedIcon} .scale=${d(this.scale)}></calcite-icon></div>` : null}<div class=${e(o.content)}><slot name=${n.title}></slot><slot name=${n.message}></slot><slot name=${n.link}></slot></div><div class=${e(o.actionsEnd)} .hidden=${!this.hasActionEnd}><slot name=${n.actionsEnd} @slotchange=${this.handleActionsEndSlotChange}></slot></div>${this.closable ? t : null}</div>`;
    }
  };
(c.properties = {
  hasActionEnd: 16,
