...
import { y as He } from './elevationInfoUtils-qqhoEgjX.js';
import { g as ke, t as Te, W as $e } from './boundedPlane-DtGHuX-9.js';
import { h as Fe } from './SketchOptions-C5ta2Z9F.js';
import { o as Pe, i as Me } from './queryEngineUtils-vWPl9AWg.js';
import { h as Ce } from './WorkerHandle-BVpxlMlF.js';
import { e as Ee } from './projectVectorToVector-wO633bLe.js';
...
let h = class extends k {
  ...
  _getOrLoadWhereFields(e, t) {
    ...
    if (!this._loadWhereModuleTask && !i) {
      const o = Ie(async () => {
        const s = await B(
          () => import('./WhereClause-CwCHdxIr.js').then((n) => n.W),
