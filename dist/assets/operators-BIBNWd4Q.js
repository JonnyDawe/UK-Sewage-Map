...
import { execute as h } from './affineTransformOperator-ZV-cRPZy.js';
import { _ as L } from './index-DShQM7Xx.js';
import { gl as $, bI as _, b0 as y, gk as N } from './index.lazy-BFilFZ3v.js';
import { u as E, a as I, s as A, c as X, i as k } from './operatorGeodesicBuffer-CIu7QxqH.js';
import { e as G } from './geodeticCurveType-CirnHLSB.js';
import { m as q } from './geodeticAreaOperator-CNngGhsV.js';
import { f as ar } from './geodeticAreaOperator-CNngGhsV.js';
import { l as V } from './geodeticDensifyOperator-BlFwI1id.js';
import { g as ir } from './geodeticDensifyOperator-BlFwI1id.js';
import { m as B } from './geodeticLengthOperator-DwgM6aU8.js';
import { f as pr } from './geodeticLengthOperator-DwgM6aU8.js';
import F from './Transformation-Bxceu7vP.js';
import { i as mr } from './areaOperator-CzFebgHD.js';
import { x as H, l as Z, f as J } from './operatorBuffer-Cf5hrSF5.js';
import {
...
import { p as yr } from './centroidOperator-BxtjsKPE.js';
import { i as xr } from './clipOperator-D3RHfzv0.js';
import { X as K, h as Q } from './ProjectionTransformation-Cq_-pOos.js';
import { X as U, _ as W, v as Y, M as ee } from './operatorConvexHull-ApsfuIpf.js';
import { t as te } from './OperatorCrosses-CNDoPNHq.js';
import { i as dr } from './cutOperator-B5OqypEB.js';
import { l as vr } from './densifyOperator-CM0dPtg4.js';
import { m as Sr } from './differenceOperator-BdLDF5F8.js';
import { i as Cr } from './distanceOperator-CY5SN3Ti.js';
import { l as Pr } from './equalsOperator-CURi6xjQ.js';
import { c as Tr } from './generalizeOperator-BKdMkOTk.js';
import { s as re, u as oe, o as ne, t as se } from './operatorIntersection-Dod0SDIQ.js';
import { t as ue } from './OperatorIntersects-CMM0rkAf.js';
import { c as Rr } from './labelPointOperator-3hfhZXOM.js';
import { D as ae, j as ce, w as ie } from './operatorOffset-Dlj7Z6NQ.js';
import { t as le } from './OperatorOverlaps-x4Lh2dpk.js';
import { g as Dr } from './proximityOperator-CiqFrHBd.js';
import { f as Lr } from './relateOperator-DorNjG3I.js';
import { s as pe, u as fe, o as me, t as $e } from './operatorSimplify-D6nu8byc.js';
import { i as Er } from './symmetricDifferenceOperator-CAA-zjRV.js';
import { t as ye } from './OperatorTouches-7ReCoj68.js';
import { s as _e, t as xe, o as be } from './operatorUnion-BJSWo6dj.js';
import { t as de } from './OperatorWithin-CdWK5fUi.js';
import './SimpleGeometryCursor-B92kdZ15.js';
import './Transformation2D-Bb72B6CZ.js';
import './jsonConverter-DC7TwnBw.js';
import './operatorGeodeticDensify-B7U1DmkD.js';
import './GeometryCleaner-BEJM7I4l-BHcstiW-.js';
import './OperatorGeneralize-BoGEiiFA.js';
import './Centroid-DZi-eb9F-C125OHYY.js';
import './OperatorProximity-XFT4mP8r.js';
function ge(e, t, o = {}) {
  const { unit: n } = o,
    s = a(e);
...
async function w() {
  if (!R()) {
    const [e] = await Promise.all([
      L(() => import('./apiConverter-BgKw0xnw.js'), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7, 8])),
      E(),
    ]);
    (x = e.fromGeometry),
