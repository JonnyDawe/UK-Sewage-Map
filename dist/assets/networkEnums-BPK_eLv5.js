import { cX as e } from './index.lazy-BHTpPf8X.js';
const i = {
...
const m = e()({ AUTOMOBILE: 'automobile', TRUCK: 'truck', WALK: 'walk', OTHER: 'other' }),
  d = e()(
    {
  ...
  h = e()({ 0: 'stop', 1: 'waypoint', 2: 'break' }, { useNumericKeys: !0 }),
  v = e()(
    {
      0: 'ok',
      1: 'not-located',
  ...
  p = e()({ 1: 'right', 2: 'left' }, { useNumericKeys: !0 }),
  A = e()({ 0: 'restriction', 1: 'scaled-cost', 2: 'added-cost' }, { useNumericKeys: !0 }),
  T = e()({ 0: 'permit', 1: 'restrict' }, { useNumericKeys: !0 }),
  N = e()(
    {
      1: 'header',
      50: 'arrive',
  ...
  f = e()({ 'NA Campus': 'campus', 'NA Desktop': 'desktop', 'NA Navigation': 'navigation' }),
  k = e()({ Kilometers: 'kilometers', Miles: 'miles', Meters: 'meters' }, { ignoreUnknown: !1 }),
  S = e()(
    {
      Minutes: 'minutes',
