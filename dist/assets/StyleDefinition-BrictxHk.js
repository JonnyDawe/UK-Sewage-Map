import { dV as f, dW as y } from './index.lazy-BHTpPf8X.js';
var p, a, u, l, m, n, o, i, r;
(function (t) {
  ...
  (function (t) {
    (t[(t.MAP = 0)] = 'MAP'), (t[(t.VIEWPORT = 1)] = 'VIEWPORT'), (t[(t.AUTO = 2)] = 'AUTO');
  })(l || (l = {})),
  (function (t) {
    (t[(t.AUTO = 0)] = 'AUTO'),
      (t[(t.LEFT = 1)] = 'LEFT'),
...
(e.backgroundLayoutDefinition = {
  ...
  (e.lineLayoutDefinition = {
    visibility: { type: 'enum', values: ['visible', 'none'], default: a.VISIBLE },
    'line-cap': { type: 'enum', values: ['butt', 'round', 'square'], default: y.BUTT },
    'line-join': { type: 'enum', values: ['bevel', 'round', 'miter'], default: f.MITER },
  ...
  (e.symbolLayoutDefinition = {
    ...
    'text-transform': { type: 'enum', values: ['none', 'uppercase', 'lowercase'], default: o.NONE },
    'text-writing-mode': {
      type: 'array',
      value: 'enum',
  ...
  (e.fillPaintDefinition = {
    ...
    'fill-translate': { type: 'array', value: 'number', length: 2, default: [0, 0] },
    'fill-translate-anchor': { type: 'enum', values: ['map', 'viewport'], default: i.MAP },
  }),
  (e.linePaintDefinition = {
    ...
    'line-translate-anchor': { type: 'enum', values: ['map', 'viewport'], default: i.MAP },
  ...
  (e.symbolPaintDefinition = {
    ...
    'icon-translate': { type: 'array', value: 'number', length: 2, default: [0, 0] },
    'icon-translate-anchor': { type: 'enum', values: ['map', 'viewport'], default: i.MAP },
    ...
    'text-translate-anchor': { type: 'enum', values: ['map', 'viewport'], default: i.MAP },
  }),
  ...
  (e.circlePaintDefinition = {
    ...
    'circle-stroke-opacity': { type: 'number', minimum: 0, maximum: 1, default: 1 },
    'circle-stroke-width': { type: 'number', minimum: 0, default: 0 },
    'circle-translate': { type: 'array', value: 'number', length: 2, default: [0, 0] },
    'circle-translate-anchor': { type: 'enum', values: ['map', 'viewport'], default: i.MAP },
  });
export { p as a, e as f, a as i, l, n as m, u as n, o, r as p, i as r, m as u };
