...
import { E as _e, I as ae } from './enums-BRzLM11V.js';
import {
  h as L,
  s as Te,
  o as oe,
  ...
  g as Je,
  _ as Qe,
} from './GeometryUtils-CELdmOaY.js';
import { t as Ce } from './Rect-CUzevAry.js';
import { o as Xe } from './config-BOD8--da.js';
import {
  l as ie,
  m as k,
  o as Ee,
  ...
  u as we,
  a as ee,
} from './StyleDefinition-BrictxHk.js';
import { a as tt, c as st, i as it } from './libtess-DK8QBy4g.js';
import { s as rt, e as nt } from './SourceLayerData-BMetklBf.js';
import { t as v, U as at, O as ot, l as lt } from './StyleRepository-juglY63w.js';
import { e as Se } from './earcut-D9gy186-.js';
import { C as ht } from './BidiEngine-QXap_35O.js';
...
function ct(f) {
  return (
    ...
    (!(f < 4352) &&
      ((f >= 12704 && f <= 12735) ||
        (f >= 12544 && f <= 12591) ||
        (f >= 65072 && f <= 65103 && !(f >= 65097 && f <= 65103)) ||
        (f >= 63744 && f <= 64255) ||
        (f >= 13056 && f <= 13311) ||
        (f >= 11904 && f <= 12031) ||
        (f >= 12736 && f <= 12783) ||
        (f >= 12288 &&
          f <= 12351 &&
          !((f >= 12296 && f <= 12305) || (f >= 12308 && f <= 12319) || f === 12336)) ||
        (f >= 13312 && f <= 19903) ||
        (f >= 19968 && f <= 40959) ||
        (f >= 12800 && f <= 13055) ||
        (f >= 12592 && f <= 12687) ||
        ...
        (f >= 65104 && f <= 65135 && !((f >= 65112 && f <= 65118) || (f >= 65123 && f <= 65126))) ||
        (f >= 5120 && f <= 5759) ||
        (f >= 6320 && f <= 6399) ||
        (f >= 65040 && f <= 65055) ||
        (f >= 19904 && f <= 19967) ||
...
let $e = class {
  ...
  getShaping(t, e, i) {
    ...
    for (const g of t) {
      ...
      o.push({ codePoint: I, x: l, y: h, vertical: w, glyphMosaicItem: _ }),
        _ && (l += _.metrics.advance + s);
    }
    let d = l;
    ...
    for (let g = 0; g < y - 1; g++) {
      ...
      if (ft(I) || w) {
        ...
        c.push(this._buildBreak(g + 1, o[g].x, d, c, _, !1));
      }
    }
    ...
    for (let g = 0; g < p.length; g++) {
      const I = p[g];
      let w = m;
      for (; w < I && ve(o[w].codePoint); ) (o[w].glyphMosaicItem = null), ++w;
      let _ = I - 1;
      for (; _ > w && ve(o[_].codePoint); ) (o[_].glyphMosaicItem = null), --_;
      if (w <= _) {
        const P = o[w].x;
        for (let T = w; T <= _; T++) (o[T].x -= P), (o[T].y = h);
        let D = o[_].x;
        o[_].glyphMosaicItem && (D += o[_].glyphMosaicItem.metrics.advance),
          (M = Math.max(D, M)),
          a && this._applyJustification(o, w, _);
      }
      (m = I), (h += x);
    }
    if (o.length > 0) {
  ...
  static getTextBox(t, e) {
    ...
    let i = 1 / 0,
      ...
      a = 0;
    for (const r of t) {
      const o = r.glyphMosaicItem.metrics.advance,
        l = r.x,
        h = r.y - He,
        d = l + o,
        u = h + e;
  ...
  static getBox(t) {
    ...
    let e = 1 / 0,
      ...
      n = 0;
    for (const a of t) {
      const { height: r, left: o, top: l, width: h } = a.glyphMosaicItem.metrics,
        d = a.x,
        u = a.y - (r - Math.abs(l)),
        c = d + h + o,
        y = u + r;
  ...
  static addDecoration(t, e) {
    ...
    if (i === 0) return;
    const s = 3;
    let n = t[0].x + t[0].glyphMosaicItem.metrics.left,
      a = t[0].y;
    for (let o = 1; o < i; o++) {
      const l = t[o];
      if (l.y !== a) {
        ...
        t.push({
          ...
          glyphMosaicItem: {
            sdf: !0,
            rect: new Ce(4, 0, 4, 8),
            metrics: { width: h - n, height: 2 + 2 * s, left: 0, top: 0, advance: 0 },
            page: 0,
            code: 0,
          },
        }),
          (a = l.y),
          (n = l.x + l.glyphMosaicItem.metrics.left);
      }
    }
    const r =
      t[i - 1].x + t[i - 1].glyphMosaicItem.metrics.left + t[i - 1].glyphMosaicItem.metrics.width;
    t.push({
      codePoint: 0,
      x: n,
      y: a + e - s,
      ...
      glyphMosaicItem: {
        sdf: !0,
        rect: new Ce(4, 0, 4, 8),
        metrics: { width: r - n, height: 2 + 2 * s, left: 0, top: 0, advance: 0 },
        page: 0,
        code: 0,
      },
    });
  ...
  _buildBreak(t, e, i, s, n, a) {
    let r = null,
      o = this._breakScore(e, i, n, a);
    for (const l of s) {
      const h = e - l.x,
        d = this._breakScore(h, i, n, a) + l.score;
      d <= o && ((r = l), (o = d));
    }
  ...
  _applyJustification(t, e, i) {
    const s = t[i],
      n = s.vertical ? K : s.glyphMosaicItem ? s.glyphMosaicItem.metrics.advance : 0,
      a = (s.x + n) * this._justify;
...
let Fe = class {
  ...
  dt = class {
    getIconPlacement(t, e, i) {
      const s = new L(t.x, t.y),
        n = i.rotationAlignment === ie.MAP,
        a = i.keepUpright;
      let r = i.rotate * Te;
      n && (r += t.angle);
      const o = new Fe([]);
      return (
        (i.allowOverlap && i.ignorePlacement) || (o.iconColliders = []),
        this._addIconPlacement(o, s, e, i, r),
        n && a && this._addIconPlacement(o, s, e, i, r + oe),
        o
      );
    }
    _addIconPlacement(t, e, i, s, n) {
      const a = i.rasterizationScale,
        r = i.width / a,
        o = i.height / a,
        l = s.offset;
      let h = l[0],
      ...
      const _ = new Re(m, w, I, g, u, n, 0, 256, e, X, se, 0);
      if ((t.shapes.push(_), (!s.allowOverlap || !s.ignorePlacement) && Xe)) {
        const P = s.size,
          D = s.padding,
          T = {
            xTile: e.x,
    ...
    getTextPlacement(t, e, i, s) {
      const n = new L(t.x, t.y),
        a = s.rotate * Te,
        r = s.rotationAlignment === ie.MAP,
        o = s.keepUpright,
        l = s.padding;
      let h = X;
      const d = r ? t.angle : 0,
        u = t.segment >= 0 && r,
        c = s.allowOverlap && s.ignorePlacement ? null : [],
        y = [],
        p = 4,
        M = !u;
      ...
      let D,
        ...
        B = 0;
      if (!u && P) {
        const b = $e.getTextBox(e, s.lineHeight * K);
        switch (s.anchor) {
          case k.LEFT:
      ...
      for (const b of e) {
        ...
        if (c && M) {
          if (D !== void 0 && D !== b.y) {
            let S, F, z, N;
            P
              ? ((S = -I + T), (F = x + B), (z = I - g), (N = m - x))
              : ((S = x + T), (F = g + B), (z = m - x), (N = I - g));
            const G = {
              xTile: t.x,
              yTile: t.y,
              dxPixels: S * _ - l,
        ...
        const Z = [];
        if (u) {
          const S = 0.5 * E.metrics.width,
            F = (b.x + C.left - p + S) * _ * le;
          if (
            ((h = this._placeGlyph(t, h, F, i, t.segment, 1, b.vertical, O, Z)),
            o && (h = this._placeGlyph(t, h, F, i, t.segment, -1, b.vertical, O, Z)),
            h >= be)
          )
            break;
        } else Z.push(new pe(n, d, d, O, !1)), r && o && Z.push(new pe(n, d + oe, d + oe, O, !1));
        const H = b.x + C.left,
          j = b.y - He - C.top,
          J = H + C.width,
          Ie = j + C.height;
        let R, $, he, ce, Q, ue, De, Be;
        if (!u && P)
          if (b.vertical) {
            const S = (H + J) / 2 - C.height / 2,
              F = (j + Ie) / 2 + C.width / 2;
            (R = new L(-F - p + T, S - p + B)),
              ($ = new L(R.x + V.width, R.y + V.height)),
              (he = new L(R.x, $.y)),
              (ce = new L($.x, R.y));
          } else
            (R = new L(-j + p + T, H - p + B)),
              ($ = new L(R.x - V.height, R.y + V.width)),
              (he = new L($.x, R.y)),
              (ce = new L(R.x, $.y));
        else
          (R = new L(H - p + T, j - p + B)),
        ...
        for (const S of Z) {
          ...
          if (S.alternateVerticalGlyph) {
            if (!Q) {
              const q = (j + Ie) / 2 + B;
              (Q = new L((H + J) / 2 + T - C.height / 2 - p, q + C.width / 2 + p)),
                (ue = new L(Q.x + V.height, Q.y - V.width)),
                (De = new L(ue.x, Q.y)),
                (Be = new L(Q.x, ue.y));
            }
            (F = Q), (z = De), (N = Be), (G = ue);
          } else (F = R), (z = he), (N = ce), (G = $);
          const fe = j,
            Me = Ie,
            de = S.glyphAngle + a;
          if (de !== 0) {
            const q = Math.cos(de),
              xe = Math.sin(de);
            (F = F.clone()),
              (z = z == null ? void 0 : z.clone()),
              (N = N == null ? void 0 : N.clone()),
              (G = G == null ? void 0 : G.clone()),
              F.rotate(q, xe),
              G == null || G.rotate(q, xe),
              z == null || z.rotate(q, xe),
              N == null || N.rotate(q, xe);
          }
          let re = 0,
            ne = 256;
          if (
            (u && P
              ? b.vertical
                ? S.alternateVerticalGlyph
                  ? ((re = 32), (ne = 96))
                  : ((re = 224), (ne = 32))
                : ((re = 224), (ne = 96))
              : ((re = 192), (ne = 64)),
            y.push(
              new Re(F, N, z, G, V, S.labelAngle, re, ne, S.anchor, S.minzoom, S.maxzoom, S.page),
            ),
            c && (!w || this._legible(S.labelAngle)))
          ) {
            if (M) H < x && (x = H), fe < g && (g = fe), J > m && (m = J), Me > I && (I = Me);
      ...
      if (c && M) {
        let b, E, V, C;
        P
          ? ((b = -I + T), (E = x + B), (V = I - g), (C = m - x))
          : ((b = x + T), (E = g + B), (V = m - x), (C = I - g));
        const O = {
          xTile: t.x,
          yTile: t.y,
          dxPixels: b * _ - l,
    ...
    _placeGlyph(t, e, i, s, n, a, r, o, l) {
      ...
      for (;;) {
        const M = y.x - c.x,
          ...
          I = M / m,
          w = x / m,
          _ = Ve(Math.atan2(w, I) + u, ke);
        if (
          (l.push(new pe(c, d, _, o, !1, g, p)), r && l.push(new pe(c, d, _, o, !0, g, p)), g <= e)
        )
          return g;
        c = y.clone();
        do {
  ...
  xt = class extends v {
    ...
    add(t, e, i, s, n, a, r, o, l, h, d, u) {
      ...
      c.push(y);
      const p = 31;
      (y = v.i8888to32(Math.round(p * i), Math.round(p * s), Math.round(p * n), Math.round(p * a))),
        c.push(y),
        (y = v.i8888to32(
          Math.round(p * r),
          Math.round(p * o),
...
class gt extends v {
  ...
  add(t, e, i, s, n, a, r) {
    ...
    const d = 15;
    return (
      (h = v.i8888to32(Math.round(d * i), Math.round(d * s), n, a)), o.push(h), r && o.push(...r), l
    );
  }
}
class ze extends v {
  ...
  add(t, e, i, s, n, a, r, o, l, h, d, u) {
    ...
    let y = v.i1616to32(t, e);
    c.push(y),
      (y = v.i1616to32(Math.round(8 * i), Math.round(8 * s))),
      c.push(y),
      (y = v.i8888to32(n / 4, a / 4, o, l)),
      c.push(y),
      (y = v.i8888to32(0, Ge(r), 10 * h, Math.min(10 * d, 255))),
      c.push(y),
      u && c.push(...u);
  }
}
...
let _t = class extends me {
    constructor(t, e, i, s, n) {
      super(t, e, i),
        (this.type = _e.CIRCLE),
        (this._circleVertexBuffer = s),
        (this._circleIndexBuffer = n);
    }
    ...
    processFeatures(t) {
      const e = this._circleVertexBuffer,
        i = this._circleIndexBuffer;
    ...
    serialize() {
      ...
      (t += this.layerUIDs.length),
        (t += this._circleVertexBuffer.array.length),
        (t += this._circleIndexBuffer.array.length);
      ...
      (e[s++] = this._circleIndexStart),
        (e[s++] = this._circleIndexCount),
        (e[s++] = this._circleVertexBuffer.array.length);
  ...
  mt = class Ke extends me {
    ...
    getResources(t, e, i) {
      ...
      if (a)
        if (a.isDataDriven) for (const r of this._features) e(a.getValue(n, r), !0);
    ...
    processFeatures(t) {
      ...
      const e = this.layer,
        i = this.zoom,
        { fillMaterial: s, outlineMaterial: n, hasDataDrivenFill: a, hasDataDrivenOutline: r } = e;
      t && t.setExtent(this.layerExtent);
      const o = e.getPaintProperty('fill-pattern'),
        l = o == null ? void 0 : o.isDataDriven;
      let h = !o && e.getPaintValue('fill-antialias', i);
      if (e.outlineUsesFillColor) {
        if (h && !e.hasDataDrivenOpacity) {
          const c = e.getPaintValue('fill-opacity', i),
            y = e.getPaintValue('fill-opacity', i + 1);
          c < 1 && y < 1 && (h = !1);
        }
        if (h && !e.hasDataDrivenColor) {
          const c = e.getPaintValue('fill-color', i),
            y = e.getPaintValue('fill-color', i + 1);
          c[3] < 1 && y[3] < 1 && (h = !1);
        }
      }
      const d = this._features,
        u = t == null ? void 0 : t.validateTessellation;
      if (l) {
        const c = [];
        for (const y of d) {
          const p = o.getValue(i, y),
            M = this._spriteInfo[p];
          if (!(M != null && M.rect)) continue;
          const x = s.encodeAttributes(y, i, e, M),
            m = h && r ? n.encodeAttributes(y, i, e) : [],
            g = y.getGeometry(t);
          c.push({ ddFillAttributes: x, ddOutlineAttributes: m, page: M.page, geometry: g }),
            c.sort((I, w) => I.page - w.page);
          for (const { ddFillAttributes: I, ddOutlineAttributes: w, page: _, geometry: P } of c)
            this._processFeature(P, h, e.outlineUsesFillColor, I, w, u, _);
        }
      } else
        for (const c of d) {
          const y = a ? s.encodeAttributes(c, i, e) : null,
            p = h && r ? n.encodeAttributes(c, i, e) : null,
            M = c.getGeometry(t);
    ...
    serialize() {
      ...
      const n = this._patternMap,
        a = n.size;
      if (((e[s++] = a), a > 0))
        for (const [r, [o, l]] of n) (e[s++] = r), (e[s++] = o), (e[s++] = l);
    ...
    _processFeature(t, e, i, s, n, a, r) {
      ...
      const o = t.length,
        l = !n || n.length === 0;
      if (e && (!i || l)) for (let u = 0; u < o; u++) this._processOutline(t[u], n);
      const h = 32;
      let d;
      for (let u = 0; u < o; u++) {
        const c = Ke._area(t[u]);
        c > h
          ? (d !== void 0 && this._processFill(t, d, s, a, r), (d = [u]))
          : c < -32 && d !== void 0 && d.push(u);
      }
      ...
      if (!(g - m < 2)) {
        for (let _ = m; _ < g; ++_) {
          _ === m
            ...
            : ((a = r), (r = o), (o = _ !== g - 1 ? t[_ + 1] : t[m]), l.assign(h));
          ...
          B > 8 && (B = 8),
            D >= 0
              ? ((y = i.add(r.x, r.y, l.x, l.y, 0, 1, e)),
                p === -1 && (p = y),
                u >= 0 && c >= 0 && y >= 0 && !P && s.add(u, c, y),
                (c = i.add(r.x, r.y, B * -d.x, B * -d.y, 0, -1, e)),
                M === -1 && (M = c),
                u >= 0 && c >= 0 && y >= 0 && !P && s.add(u, c, y),
                (u = c),
                (c = y),
                (y = i.add(r.x, r.y, d.x, d.y, 0, 1, e)),
                u >= 0 && c >= 0 && y >= 0 && !P && s.add(u, c, y),
                (c = i.add(r.x, r.y, h.x, h.y, 0, 1, e)),
                u >= 0 && c >= 0 && y >= 0 && !P && s.add(u, c, y))
              : ((y = i.add(r.x, r.y, B * d.x, B * d.y, 0, 1, e)),
                p === -1 && (p = y),
                u >= 0 && c >= 0 && y >= 0 && !P && s.add(u, c, y),
                (c = i.add(r.x, r.y, -l.x, -l.y, 0, -1, e)),
                M === -1 && (M = c),
                u >= 0 && c >= 0 && y >= 0 && !P && s.add(u, c, y),
                (u = c),
                (c = y),
                (y = i.add(r.x, r.y, -d.x, -d.y, 0, -1, e)),
                u >= 0 && c >= 0 && y >= 0 && !P && s.add(u, c, y),
                (u = i.add(r.x, r.y, -h.x, -h.y, 0, -1, e)),
                u >= 0 && c >= 0 && y >= 0 && !P && s.add(u, c, y));
        }
        u >= 0 && c >= 0 && p >= 0 && !x && s.add(u, c, p),
          u >= 0 && p >= 0 && M >= 0 && !x && s.add(u, M, p),
          (this._outlineIndexCount += 3 * (s.index - n));
      }
    }
    _processFill(t, e, i, s, n) {
      ...
      e.length > 1 && (a = []);
      let r = 0;
      for (const d of e) r !== 0 && a.push(r), (r += t[d].length);
      const o = 2 * r,
        l = Le.acquire();
      for (const d of e) {
        const u = t[d],
          c = u.length;
        for (let y = 0; y < c; ++y) l.push(u[y].x, u[y].y);
      }
      const h = Se(l, a, 2);
      if (s && Se.deviation(l, a, 2, h) > 0) {
        const d = e.map((y) => t[y].length),
          { buffer: u, vertexCount: c } = tt(l, d);
        if (c > 0) {
          const y = this._fillVertexBuffer.index;
          for (let p = 0; p < c; p++) this._fillVertexBuffer.add(u[2 * p], u[2 * p + 1], i);
          for (let p = 0; p < c; p += 3) {
            const M = y + p;
            this._fillIndexBuffer.add(M, M + 1, M + 2);
          }
          if (n !== void 0) {
            const p = this._patternMap,
              M = p.get(n);
        ...
        if (d > 0) {
          ...
          let y = 0;
          for (; y < d; ) this._fillIndexBuffer.add(u + h[y++], u + h[y++], u + h[y++]);
          if (n !== void 0) {
            const p = this._patternMap,
              M = p.get(n);
...
class Mt extends me {
  constructor(t, e, i, s, n) {
    super(t, e, i),
      (this.type = _e.LINE),
      (this._tessellationOptions = { pixelCoordRatio: 8, halfWidth: 0, offset: 0 }),
      (this._patternMap = new Map()),
      ...
      (this.tessellationProperties._lineIndexBuffer = n),
  ...
  getResources(t, e, i) {
    const s = this.layer,
      n = this.zoom,
      a = s.getPaintProperty('line-pattern'),
      r = s.getPaintProperty('line-dasharray'),
      o = s.getLayoutProperty('line-cap');
    if (!a && !r) return;
    const l = (o == null ? void 0 : o.getValue(n)) || 0,
      h = o == null ? void 0 : o.isDataDriven,
      d = a == null ? void 0 : a.isDataDriven,
      u = r == null ? void 0 : r.isDataDriven;
    if (d || u)
  ...
  processFeatures(t) {
    ...
    const e = this.layer,
      ...
      { hasDataDrivenLine: a, lineMaterial: r } = e;
    t && t.setExtent(this.layerExtent);
    const o = e.getPaintProperty('line-pattern'),
      l = e.getPaintProperty('line-dasharray'),
      h = o == null ? void 0 : o.isDataDriven,
      d = l == null ? void 0 : l.isDataDriven;
    let u;
    u = e.getLayoutProperty('line-cap');
    const c = u != null && u.isDataDriven ? u : null,
      y = c ? null : e.getLayoutValue('line-cap', i),
      p = y || 0,
      M = !!c;
    u = e.getLayoutProperty('line-join');
    const x = u != null && u.isDataDriven ? u : null,
      m = x ? null : e.getLayoutValue('line-join', i);
    u = e.getLayoutProperty('line-miter-limit');
    const g = u != null && u.isDataDriven ? u : null,
      I = g ? null : e.getLayoutValue('line-miter-limit', i);
    u = e.getLayoutProperty('line-round-limit');
    const w = u != null && u.isDataDriven ? u : null,
      _ = w ? null : e.getLayoutValue('line-round-limit', i);
    u = e.getPaintProperty('line-width');
    const P = u != null && u.isDataDriven ? u : null,
      D = P ? null : e.getPaintValue('line-width', i);
    u = e.getPaintProperty('line-offset');
    const T = u != null && u.isDataDriven ? u : null,
      B = T ? null : e.getPaintValue('line-offset', i);
    if (h || d) {
      const A = [];
      for (const b of s) {
        const E = h ? o.getValue(i, b) : this._getDashArrayKey(b, i, e, l, M, c, p),
          V = this._spriteInfo[E];
        if (!(V != null && V.rect)) continue;
        const C = r.encodeAttributes(b, i, e, V),
          O = b.getGeometry(t);
        A.push({
          ddAttributes: C,
          page: V.page,
          cap: c ? c.getValue(i, b) : y,
          join: x ? x.getValue(i, b) : m,
          miterLimit: g ? g.getValue(i, b) : I,
          roundLimit: w ? w.getValue(i, b) : _,
          halfWidth: 0.5 * (P ? P.getValue(i, b) : D),
          offset: T ? T.getValue(i, b) : B,
          geometry: O,
        });
      }
      ...
      for (const {
        ...
        (n.capType = V),
          ...
          (n.halfWidth = H),
          (n.offset = j),
          this._processFeature(J, b, E);
    } else {
      if (o) {
        const A = o.getValue(i),
          b = this._spriteInfo[A];
        if (!(b != null && b.rect)) return;
      }
      (n.textured = !(!o && !l)),
        (n.capType = y),
        (n.joinType = m),
      ...
      for (const A of s) {
        ...
        c && (n.capType = c.getValue(i, A)),
          x && (n.joinType = x.getValue(i, A)),
          g && (n.miterLimit = g.getValue(i, A)),
          w && (n.roundLimit = w.getValue(i, A)),
          P && (n.halfWidth = 0.5 * P.getValue(i, A)),
          T && (n.offset = T.getValue(i, A));
  ...
  _getDashArrayKey(t, e, i, s, n, a, r) {
    const o = n ? a.getValue(e, t) : r,
      l = s.getValue(e, t);
    return i.getDashKey(l, o);
  }
}
const Pt = (f) => (t, e, i, s, n, a, r, o, l, h, d) => (
    f._lineVertexBuffer.add(t, e, r, o, i, s, n, a, l, h, d, f._ddValues),
    f._lineVertexBuffer.index - 1
  ),
  wt = (f) => (t, e, i) => {
  ...
  Ne = 10;
function bt(f, t) {
  return f.iconMosaicItem && t.iconMosaicItem
    ? f.iconMosaicItem.page === t.iconMosaicItem.page
      ? 0
      : f.iconMosaicItem.page - t.iconMosaicItem.page
    : f.iconMosaicItem && !t.iconMosaicItem
      ? 1
      : !f.iconMosaicItem && t.iconMosaicItem
        ? -1
        : 0;
...
class U extends me {
  ...
  getResources(t, e, i) {
    ...
    let o = s.getLayoutProperty('text-transform'),
      l = s.getLayoutProperty('text-font');
    const h = [];
    let d, u, c, y;
    a && !a.isDataDriven && (d = a.getValue(n)),
      r && !r.isDataDriven && (u = r.getValue(n)),
      (o && o.isDataDriven) || ((c = s.getLayoutValue('text-transform', n)), (o = null)),
      (l && l.isDataDriven) || ((y = s.getLayoutValue('text-font', n)), (l = null));
    for (const p of this._features) {
      ...
      let g = !1;
      if (r && ((m = r.isDataDriven ? r.getValue(n, p) : this._replaceKeys(u, p.values)), m)) {
        switch (
          ((m = m.replaceAll(
            '\\n',
            `
`,
        ...
        if (U._bidiEngine.hasBidiChar(m)) {
          let _;
          (_ = U._bidiEngine.checkContextual(m) === 'rtl' ? 'IDNNN' : 'ICNNN'),
            (m = U._bidiEngine.bidiTransform(m, _, 'VLYSN')),
            (g = !0);
        }
        if (m.length > 0) {
          l && (y = l.getValue(n, p));
      ...
      if (!x && !m) continue;
      const I = s.getLayoutValue('symbol-sort-key', n, p),
        w = {
          feature: p,
          sprite: x,
          label: m,
  ...
  processFeatures(t) {
    ...
    const e = this.layer,
      ...
      n = s !== Pe.POINT,
      a = e.getLayoutValue('symbol-spacing', i) * le,
      r = e.getLayoutProperty('icon-image'),
      o = e.getLayoutProperty('text-field'),
      l = r ? new at(e, i, n) : null,
      h = o ? new ot(e, i, n) : null,
      d = this._workerTileHandler;
    let u;
    r && (u = d.getSpriteItems()),
    ...
    const c = [];
    let y = 1;
    h != null && h.size && (y = h.size / K);
    const p = h ? h.maxAngle * Te : 0,
      M = h ? h.size * le : 0;
    for (const x of this._symbolFeatures) {
      let m;
      l && u && x.sprite && ((m = u[x.sprite]), m && m.sdf && (this._isIconSDF = !0));
      let g;
      m && l.update(i, x.feature);
      let I = 0;
      const w = x.label;
      if (w) {
        We(h), h.update(i, x.feature);
        const _ =
          n && h.rotationAlignment === ie.MAP
            ? h.keepUpright
            : h.writingMode && h.writingMode.includes(et.VERTICAL);
        let P = 0.5;
        switch (h.anchor) {
          case k.TOP_LEFT:
          case k.LEFT:
        ...
        const B = h.letterSpacing * K,
          A = n ? 0 : h.maxWidth * K,
          b = h.lineHeight * K,
          E = x.textFont.map((V) => d.getGlyphItems(V));
        if (((g = new $e(E, A, b, B, P, D, T).getShaping(w, x.rtl, _)), g && g.length > 0)) {
          let V = 1e30,
            C = -1e30;
      ...
      for (let _ of x.geometry) {
        ...
        if (s === Pe.LINE) {
          if (g != null && g.length && h != null && h.size) {
            ...
            _ = U._smoothVertices(_, D);
          }
          U._pushAnchors(P, _, a, I);
        } else
          s === Pe.LINE_CENTER
            ? U._pushCenterAnchor(P, _)
            : x.feature.type === Ye.Polygon
              ? U._pushCentroid(P, _)
              : P.push(new ge(_[0].x, _[0].y));
        for (const D of P) {
          if (
            D.x < 0 ||
            D.x > Oe ||
            ...
            (n &&
              I > 0 &&
              (h == null ? void 0 : h.rotationAlignment) === ie.MAP &&
              !U._honorsTextMaxAngle(_, D, I, p, M))
          )
            continue;
          const T = {
            shaping: g,
  ...
  serialize() {
    ...
    (t += this.layerUIDs.length),
      ...
      (t += U._symbolsSerializationLength(this._symbolInstances)),
    ...
    const e = new Uint32Array(t),
      ...
      [n, a, r] = this._sourceTileKey.split('/');
    let o = 0;
    (e[o++] = this.type), (e[o++] = this.layerUIDs.length);
    for (let l = 0; l < this.layerUIDs.length; l++) e[o++] = this.layerUIDs[l];
    (e[o++] = this._isIconSDF ? 1 : 0),
      (e[o++] = parseFloat(n)),
      (e[o++] = parseFloat(a)),
      (e[o++] = parseFloat(r)),
      (e[o++] = this.markerPageMap.size);
    for (const [l, [h, d]] of this.markerPageMap) (e[o++] = l), (e[o++] = h), (e[o++] = d);
    e[o++] = this.glyphsPageMap.size;
    for (const [l, [h, d]] of this.glyphsPageMap) (e[o++] = l), (e[o++] = h), (e[o++] = d);
    (e[o++] = this._iconVertexBuffer.index / 4),
      (e[o++] = this._textVertexBuffer.index / 4),
      (o = U.serializeSymbols(e, i, s, o, this._symbolInstances)),
      (e[o++] = this._iconVertexBuffer.array.length);
  ...
  static _symbolsSerializationLength(t) {
    ...
    for (const i of t || []) {
      (e += 5), (e += 1);
      for (const s of i.textColliders) e += Ne;
      for (const s of i.iconColliders) e += Ne;
      (e += 1),
  ...
  static serializeSymbols(t, e, i, s, n) {
    ...
    for (const a of n) {
      (e[s++] = a.anchor.x),
        (e[s++] = a.anchor.y),
        (e[s++] = a.symbolFeature.hash),
        (e[s++] = a.symbolFeature.priority),
        (e[s++] = a.symbolFeature.feature.featureIndex),
        (e[s++] = a.textColliders.length + a.iconColliders.length);
  ...
  _processFeature(t, e, i) {
    const { line: s, iconMosaicItem: n, shaping: a, anchor: r } = t,
      o = this.zoom,
      l = this.layer,
      h = !!n;
    let d = !0;
    ...
    const u = a && a.length > 0,
      c = !u || (i == null ? void 0 : i.optional);
    let y, p;
    if (
      (h && (y = this._placementEngine.getIconPlacement(r, n, e)),
      (y || d) && (u && (p = this._placementEngine.getTextPlacement(r, a, s, i)), p || c))
    ) {
      if (
        ((y && p) ||
          (c || d ? (c || p ? d || y || (p = null) : (y = null)) : ((y = null), (p = null))),
        p)
      ) {
        const M = l.hasDataDrivenText
          ? l.textMaterial.encodeAttributes(t.symbolFeature.feature, o, l)
          : null;
        if ((this._storePlacedGlyphs(t, p.shapes, o, i.rotationAlignment, M), p.textColliders)) {
          ...
          for (const x of p.textColliders) {
            ...
            if (m) {
              const g = Math.cos(m),
                I = Math.sin(m),
                w = x.dxPixels * g - x.dyPixels * I,
                _ = x.dxPixels * I + x.dyPixels * g,
                P = (x.dxPixels + x.width) * g - x.dyPixels * I,
                D = (x.dxPixels + x.width) * I + x.dyPixels * g,
                T = x.dxPixels * g - (x.dyPixels + x.height) * I,
                B = x.dxPixels * I + (x.dyPixels + x.height) * g,
                A = (x.dxPixels + x.width) * g - (x.dyPixels + x.height) * I,
                b = (x.dxPixels + x.width) * I + (x.dyPixels + x.height) * g,
                E = Math.min(w, P, T, A),
                V = Math.max(w, P, T, A),
                C = Math.min(_, D, B, b),
                O = Math.max(_, D, B, b);
      ...
      if (y) {
        const M = l.hasDataDrivenIcon
          ? l.iconMaterial.encodeAttributes(t.symbolFeature.feature, o, l)
          : null;
        if (
          (this._addPlacedIcons(t, y.shapes, o, n.page, e.rotationAlignment === ie.VIEWPORT, M),
          y.iconColliders)
        ) {
  ...
  _addPlacedIcons(t, e, i, s, n, a) {
    const r = Math.max(i - 1, 0),
      o = this._iconVertexBuffer,
      l = this._iconIndexBuffer,
      h = this._markerMap;
    for (const d of e) {
      const u = n ? 0 : Math.max(i + Y(d.minzoom), r),
        c = n ? 25 : Math.min(i + Y(d.maxzoom), 25);
      if (c <= u) continue;
      const y = d.tl,
        p = d.tr,
        M = d.bl,
        ...
        A = T + m.height,
        b = o.index;
      o.add(_.x, _.y, y.x, y.y, D, T, g, I, w, u, c, a),
        o.add(_.x, _.y, p.x, p.y, B, T, g, I, w, u, c, a),
        o.add(_.x, _.y, M.x, M.y, D, A, g, I, w, u, c, a),
        o.add(_.x, _.y, x.x, x.y, B, A, g, I, w, u, c, a),
        t.iconVertexRanges.length > 0 && t.iconVertexRanges[0][0] + t.iconVertexRanges[0][1] === b
          ? (t.iconVertexRanges[0][1] += 4)
          : t.iconVertexRanges.push([b, 4]),
        l.add(P, P + 1, P + 2),
        l.add(P + 1, P + 2, P + 3),
        h.has(s) ? (h.get(s)[1] += 6) : h.set(s, [this._iconIndexStart + this._iconIndexCount, 6]),
    ...
    for (const [s, n] of this._glyphBufferDataStorage)
      for (const a of n) {
        ...
        t.add(
          ...
          o.textVertexRanges.length > 0 && o.textVertexRanges[0][0] + o.textVertexRanges[0][1] === h
            ? (o.textVertexRanges[0][1] += 4)
            : o.textVertexRanges.push([h, 4]),
          e.add(r, r + 1, r + 2),
          e.add(r + 1, r + 2, r + 3),
          i.has(s)
            ? (i.get(s)[1] += 6)
  ...
  _storePlacedGlyphs(t, e, i, s, n) {
    const a = Math.max(i - 1, 0),
      r = s === ie.VIEWPORT;
    let o, l, h, d, u, c, y, p, M, x, m;
    for (const g of e)
      (o = r ? 0 : Math.max(i + Y(g.minzoom), a)),
        (l = r ? 25 : Math.min(i + Y(g.maxzoom), 25)),
        !(l <= o) &&
          ((h = g.tl),
          (d = g.tr),
          (u = g.bl),
          ...
          (x = g.anchor),
          (m = g.mosaicRect),
          this._glyphBufferDataStorage.has(g.page) || this._glyphBufferDataStorage.set(g.page, []),
  ...
  static _pushAnchors(t, e, i, s) {
    ...
    let n = 0;
    const a = e.length - 1;
    for (let u = 0; u < a; u++) n += L.distance(e[u], e[u + 1]);
    let r = s || i;
    if (((r *= 0.5), n <= r)) return;
    const o = r / n;
    let l = 0,
      h = -(i = n / Math.max(Math.round(n / i), 1)) / 2;
    const d = e.length - 1;
    for (let u = 0; u < d; u++) {
      const c = e[u],
        y = e[u + 1],
      ...
      for (; h + i < l + x; ) {
        ...
        const g = (h - l) / x,
          I = ye(c.x, y.x, g),
          w = ye(c.y, y.y, g);
        m === void 0 && (m = Math.atan2(M, p)), t.push(new ge(I, w, m, u, o));
      }
      l += x;
    }
  }
  ...
  static _deviation(t, e, i) {
    const s = (e.x - t.x) * (i.x - e.x) + (e.y - t.y) * (i.y - e.y),
      n = (e.x - t.x) * (i.y - e.y) - (e.y - t.y) * (i.x - e.x);
  ...
  static _honorsTextMaxAngle(t, e, i, s, n) {
    ...
    for (; a < r; ) {
      ...
      for (h.push({ deviation: m, distToAnchor: a }), d += m; a - h[0].distToAnchor > n; )
        d -= h.shift().deviation;
      if (Math.abs(d) > s) return !1;
    ...
    for (let p = 1; p < i - 1; p++) {
      ...
      for (let g = p - 1; g >= 0; g--) {
        ...
        const P = _ * _,
          ...
          A = t[g].x - B.x,
          b = t[g].y - B.y;
        (M += (T / D) * (B.x * _ * I + 0.5 * P * (I * A - w * B.x) - (P * _ * w * A) / 3)),
          (x += (T / D) * (B.y * _ * I + 0.5 * P * (I * b - w * B.y) - (P * _ * w * b) / 3)),
          (m += T);
      }
      for (let g = p + 1; g < i; g++) {
        const I = y - s[g - 1] + s[p];
  ...
  static _pushCentroid(t, e) {
    ...
    for (let c = 1; c < r; c++) {
      ...
      y > 4096 && (y = 4096),
        ...
        x > 4096 && (x = 4096),
        x < 0 && (x = 0);
      const m = (y - d) * (x - u) - (M - d) * (p - u);
      (o += m * (d + y + M)), (l += m * (u + p + x)), (h += m);
    }
    (o /= 3 * h), (l /= 3 * h), isNaN(o) || isNaN(l) || t.push(new ge(o, l));
  }
}
U._bidiEngine = new ht();
var W;
(function (f) {
  (f[(f.INITIALIZED = 0)] = 'INITIALIZED'),
    (f[(f.NO_DATA = 1)] = 'NO_DATA'),
    (f[(f.READY = 2)] = 'READY'),
    (f[(f.MODIFIED = 3)] = 'MODIFIED'),
    (f[(f.INVALID = 4)] = 'INVALID');
})(W || (W = {}));
class Tt {
  constructor(t, e, i, s, n, a) {
    ...
    if (
      ...
      (this._client = i),
      (this._tile = e),
      (this._sourceDataMaxLOD = s),
      a)
    ) {
      this._styleLayerUIDs = new Set();
      for (const u of a) this._styleLayerUIDs.add(u);
    }
    (this._styleRepository = n),
      (this._layers = ((d = this._styleRepository) == null ? void 0 : d.layers) ?? []);
    ...
    for (const u of Object.keys(t)) {
      const c = t[u];
      if (
        ((this._pbfTiles[u] = new je(new Uint8Array(c.protobuff), new DataView(c.protobuff))),
        c.refKey)
      ) {
        const [y] = c.refKey.split('/').map(parseFloat),
          p = r - y;
        if (p > 0) {
          const M = (1 << p) - 1,
            x = o & M,
            m = l & M;
          this._tileClippers[u] = new Je(p, x, m, 8, h);
        }
      }
  ...
  async parse(t) {
    ...
    if (this._tile.status === W.INVALID) return [];
  ...
  _processLayers(t) {
    const {
        ...
        zoom: i,
        layers: s,
        sourceNameToTileClipper: n,
        sourceNameToUniqueSourceLayerBuckets: a,
        sourceNameToUniqueSourceLayers: r,
        returnedBuckets: o,
        layerIdToBucket: l,
        referencerUIDToReferencedId: h,
      } = t,
      d = this._sourceDataMaxLOD;
    for (let u = s.length - 1; u >= 0; u--) {
      ...
      if (
        c.type === ee.BACKGROUND ||
        !this._canParseStyleLayer(c.uid) ||
        !e[c.source] ||
        !n[c.source]
      )
        continue;
      ...
      if (x) {
        let m = r[c.source];
        if ((m || (m = r[c.source] = new Set()), m.add(c.sourceLayer), c.refLayerId))
  ...
  _fetchResources(t, e, i) {
    const s = [],
      n = this._tile.getWorkerTileHandler();
    let a, r;
  ...
  _createFillBucket(t) {
    return new mt(
      ...
      new yt(t.fillMaterial.getStride()),
      new te(),
      new gt(t.outlineMaterial.getStride()),
      new te(),
    );
  }
  _createLineBucket(t) {
    return new Mt(
      ...
      this._level,
      this._tile.getWorkerTileHandler().getSpriteItems(),
      new xt(t.lineMaterial.getStride()),
      new te(),
    );
  }
  _createCircleBucket(t) {
    return new _t(
      ...
      this._level,
      this._tile.getWorkerTileHandler().getSpriteItems(),
      new pt(t.circleMaterial.getStride()),
      new te(),
    );
  }
  _createSymbolBucket(t) {
    ...
    return new U(
      ...
      t,
      this._level,
      new ze(t.iconMaterial.getStride()),
      new te(),
      new ze(t.textMaterial.getStride()),
      new te(),
      e.placementEngine,
...
let Dt = class {
  constructor(t, e, i, s) {
    (this.status = W.INITIALIZED),
      (this.placementEngine = new dt()),
      (this.tileKey = t),
      (this.refKeys = e),
  ...
  async parse(t, e) {
    ...
    let l = null;
    return (
      r.length > 0 && ((l = Uint32Array.from(r)), o.push(l.buffer)),
      (n.emptyBuckets = l),
      { result: n, transferList: o }
    );
  }
  setObsolete() {
...
class Yt {
  ...
  async createTileAndParse(t, e) {
    ...
    try {
      ...
      if ((n.setObsolete(), n.release(), !Ue(a))) throw a;
      return null;
    }
  }
  updateStyle(t) {
  ...
  setStyle(t) {
    ...
    (this._styleRepository = new lt(e)),
  ...
  fetchSprites(t, e, i) {
    const s = [],
      n = this._spriteInfo;
    for (const a of t) n[a.name] === void 0 && s.push(a);
    return s.length === 0
      ? Promise.resolve()
      : e.invoke('getSprites', s, { signal: i == null ? void 0 : i.signal }).then((a) => {
          for (const r in a) {
            const o = a[r];
            n[r] = o;
          }
  ...
  fetchGlyphs(t, e, i, s, n) {
    ...
    return (
      r
        ...
        : ((r = this._glyphInfo[e] = []), i.forEach((o) => a.push(o))),
      a.length === 0
        ? Promise.resolve()
        : s.invoke('getGlyphs', { tileID: t, font: e, codePoints: a }, n).then((o) => {
