import { cH as o, cI as h } from './index.lazy-BFilFZ3v.js';
import { s as a } from './PooledRBush-5_hwDN_k.js';
const _ = 5e4,
...
class B {
      ...
      (this._loadIndex = () => {
        if (this._indexInvalid) {
          ...
          this._boundsToLoad.length &&
            (this._index.load(
              Array.from(new Set(this._boundsToLoad.filter((s) => this._idByBounds.has(s)))),
            ),
  ...
  delete(s) {
    ...
    this._boundsById.delete(s),
      i && (this._idByBounds.delete(i), this._indexInvalid || this._index.remove(i));
  }
  forEachInBounds(s, i) {
    this._loadIndex(), u(this._index, s, (n) => i(this._idByBounds.get(n)));
  }
  get(s) {
  ...
  set(s, i) {
    ...
    this._boundsById.set(s, i),
      i &&
        ...
        this._indexInvalid ||
          (this._boundsToLoad.push(i), this._boundsToLoad.length > _ && this._loadIndex()));
  }
}
export { B as o };
