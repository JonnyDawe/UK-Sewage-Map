const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/uploadAssets-C2Ig_vML.js',
      ...
      'assets/meshSpatialReferenceScaleUtils-DaEuWguT.js',
      ...
      'assets/convertMeshVertexSpace-0xYfFRvv.js',
...
import { n as fe } from './MeshLocalVertexSpace-7O0-32Cx.js';
import { t as ge } from './meshVertexSpaceUtils-Dx1K8Ka4.js';
import { A as we } from './External-DqFhi187.js';
import { N as be } from './MeshTransform-CL1w8m2X.js';
import {
  isFeatureIdentifierArrayWithGlobalId as Ie,
  isFeatureIdentifierArrayWithObjectId as qe,
} from './editingSupport-CzYSD5MK.js';
import { F as Re } from './QueryTask-DCcZ9lCh.js';
...
let S = class extends X {
  ...
  async uploadAssets(t, e) {
    const { uploadAssets: s } = await D(
      () => import('./uploadAssets-C2Ig_vML.js'),
          ...
          { convertMeshVertexSpace: l } = await D(
            async () => {
              const { convertMeshVertexSpace: c } = await import(
                './convertMeshVertexSpace-0xYfFRvv.js'
              );
