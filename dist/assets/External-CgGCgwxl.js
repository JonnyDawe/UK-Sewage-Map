import { P as g, aT as p, aU as b, aV as N, aW as A } from './index.lazy-BHTpPf8X.js';
class m {
  constructor(r, s, t) {
  ...
  equals(r) {
    return (
      this === r ||
      (this.assetName === r.assetName &&
        this.assetMimeType === r.assetMimeType &&
        b(this.parts, r.parts, (s, t) => s.equals(t)))
    );
  }
  isOnService(r) {
...
function B(e) {
  return v(e == null ? void 0 : e.source);
}
function u(e) {
  return Array.isArray(e) ? e.every((r) => r instanceof m) : !1;
}
const c = /^(model\/gltf\+json)|(model\/gltf-binary)$/,
  f = /\.(gltf|glb)/i;
function v(e) {
  return e ? (Array.isArray(e) ? e.some(l) : l(e)) : !1;
}
function l(e) {
  if (e instanceof File) {
    const { type: r, name: s } = e;
    return c.test(r) || f.test(s);
  }
  return c.test(e.assetMimeType) || f.test(e.assetName);
}
function H(e, r) {
  if (!e) return !1;
  const { source: s } = e;
...
function M(e, r) {
  ...
  if (u(s) && u(t)) {
    ...
    const n = (a, o) => (a.assetName < o.assetName ? -1 : a.assetName > o.assetName ? 1 : 0),
      i = [...s].sort(n),
      y = [...t].sort(n);
...
export { S as A, O as N, m as a, q as b, M as h, U as i, H as m, B as o };
