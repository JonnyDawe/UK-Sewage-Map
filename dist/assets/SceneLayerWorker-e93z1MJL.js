...
import { f4 as Q, cJ as X, W as $, h5 as Z } from './index.lazy-BHTpPf8X.js';
import { n as ee, a as te } from './MeshLocalVertexSpace-cTk7IO-v.js';
import { n as re, d as oe } from './vec3-DUd4WD2P.js';
import './projectVectorToVector-BxN8sKqR.js';
import './sphere-vpbSSw5q.js';
import './I3SUtil-BU9ujABi.js';
...
async function Ve(e) {
  ...
  const [{ projectBuffer: d }, { initializeProjection: b }] = await Promise.all([
    I(() => import('./index.lazy-BHTpPf8X.js').then((l) => l.w5), __vite__mapDeps([2, 3, 4, 5])),
    I(() => import('./index.lazy-BHTpPf8X.js').then((l) => l.w6), __vite__mapDeps([2, 3, 4, 5])),
  ]);
  await b(c, a);
  const E = [0, 0, 0];
      ...
      { projectMeshVertexPositions: u } = await I(
        async () => {
          const { projectMeshVertexPositions: h } = await import(
            './projectMeshVertexPositions-49qJomMj.js'
          );
