import { be as i, A as s, B as r, R as p, aj as a } from './index.lazy-BFilFZ3v.js';
const o = new i({
...
s([r({ type: String, json: { write: !0 } })], e.prototype, 'description', void 0),
  s([r({ type: String, json: { read: o.read, write: o.write } })], e.prototype, 'type', void 0),
  (e = s([p('esri.rest.support.GPMessage')], e));
const y = e;
export { y as a };
