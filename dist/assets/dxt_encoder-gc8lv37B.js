...
var Zt = (L, x, N) =>
  x in L ? Yt(L, x, { enumerable: !0, configurable: !0, writable: !0, value: N }) : (L[x] = N);
var $ = (L, x, N) => Zt(L, typeof x != 'symbol' ? x + '' : x, N);
var Te,
  lr,
  rn =
    ((Te =
      typeof document < 'u' ? ((lr = document.currentScript) == null ? void 0 : lr.src) : void 0),
    function (L = {}) {
      var x,
        N,
        d = L,
        ...
        fr = typeof window == 'object',
        ne = typeof WorkerGlobalScope < 'u';
      ...
      var me,
        ...
        z = '';
      function cr(e) {
        return d.locateFile ? d.locateFile(e, z) : z + e;
      }
      (fr || ne) &&
        (ne
      ...
      var ve = d.print || console.log.bind(console),
        U = d.printErr || console.error.bind(console);
      Object.assign(d, Ce),
        (Ce = null),
        d.arguments && d.arguments,
        d.thisProgram && (Me = d.thisProgram);
      var ae,
        F,
        P,
        Q,
      ...
      function $e() {
        ...
        (d.HEAP8 = F = new Int8Array(e)),
          (d.HEAP16 = Q = new Int16Array(e)),
          (d.HEAPU8 = P = new Uint8Array(e)),
          (d.HEAPU16 = ie = new Uint16Array(e)),
          (d.HEAP32 = E = new Int32Array(e)),
          (d.HEAPU32 = y = new Uint32Array(e)),
          (d.HEAPF32 = je = new Float32Array(e)),
          (d.HEAPF64 = xe = new Float64Array(e));
      }
      var Ne = [],
        ze = [],
        Oe = [];
      ...
      function pr() {
        d.noFSInit || o.initialized || o.init(), (o.ignorePermissions = !1), ge(ze);
      }
      function mr() {
        if (d.postRun)
      ...
      function We(e) {
        var r;
        H++, (r = d.monitorRunDependencies) == null || r.call(d, H);
      }
      function we(e) {
        var t;
        if ((H--, (t = d.monitorRunDependencies) == null || t.call(d, H), H == 0 && Y)) {
          var r = Y;
          (Y = null), r();
        }
      }
      ...
      var ye,
        w,
        _,
        gr = 'data:application/octet-stream;base64,',
        Be = (e) => e.startsWith(gr);
      function Er() {
        var e = 'dxt_encoder.wasm';
        return Be(e) ? e : cr(e);
      }
      function kr(e) {
        if (e == ye && se) return new Uint8Array(se);
        if (oe) return oe(e);
      ...
      async function _r(e, r) {
        try {
          ...
          U(`failed to asynchronously prepare wasm: ${n}`), ue(n);
        }
      }
      ...
      async function Pr() {
        function e(a, i) {
          return (T = a.exports), (ae = T.G), $e(), (Ge = T.J), wr(T.H), we(), T;
        }
        function r(a) {
          e(a.instance);
        }
        ...
        if (d.instantiateWasm)
          try {
            ...
            U(`Module.instantiateWasm callback failed with error: ${a}`), N(a);
          }
        ye ?? (ye = Er());
        try {
          var n = await Ar(se, ye, t);
          return r(n), n;
        } catch (a) {
          return void N(a);
        }
      ...
      class Dr {
        ...
        get_caught() {
          return F[this.ptr + 12] != 0;
        }
        set_rethrown(r) {
          (r = r ? 1 : 0), (F[this.ptr + 13] = r);
        }
        get_rethrown() {
          return F[this.ptr + 13] != 0;
        }
        init(r, t) {
      ...
      var Ue,
        ...
        jr = (e, r, t) => {
          function n(u) {
            ...
            for (var f = 0; f < e.length; ++f) O(e[f], l[f]);
          }
          e.forEach((u) => (le[u] = r));
      ...
      function xr(e, r, t = {}) {
        var n = r.name;
        if (
          (e || S(`type "${n}" must have a positive integer typeid pointer`), I.hasOwnProperty(e))
        ) {
          if (t.ignoreDuplicateRegistrations) return;
          S(`Cannot register type '${n}' twice`);
        }
        if (((I[e] = r), delete le[e], X.hasOwnProperty(e))) {
          var a = X[e];
          delete X[e], a.forEach((i) => i());
        }
      }
      function O(e, r, t = {}) {
        return xr(e, r, t);
      ...
      var V = 8,
        ...
        W = [],
        ke = (e) => {
          e > 9 && --W[e + 1] == 0 && ((W[e] = void 0), Ee.push(e));
        },
        $r = () => W.length / 2 - 5 - Ee.length,
        Nr = () => {
          W.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), (d.count_emval_handles = $r);
        },
        D = {
          toValue: (e) => (e || S('Cannot use deleted val. handle = ' + e), W[e]),
          toHandle: (e) => {
            switch (e) {
              case void 0:
                return 2;
      ...
      var zr = {
        ...
        Wr = (e, r) => {
          switch (r) {
            ...
            case 8:
              return function (t) {
                return this.fromWireType(xe[t >> 3]);
              };
            default:
        ...
        de = (e, r) => Object.defineProperty(r, 'name', { value: e }),
        Ve = (e) => {
          for (; e.length; ) {
            var r = e.pop();
            e.pop()(r);
      ...
      function Ur(e, r, t, n) {
        for (var a = qe(e), i = e.length - 2, s = [], u = ['fn'], l = 0; l < i; ++l)
          s.push(`arg${l}`), u.push(`arg${l}Wired`);
        (s = s.join(',')), (u = u.join(','));
        var f = `return function (${s}) {
`;
        a &&
          (f += `var destructors = [];
`);
        var h = a ? 'destructors' : 'null',
          c = [
            'humanName',
            'throwBindingError',
            'invoker',
        ...
        for (l = 0; l < i; ++l)
          (f += `var arg${l}Wired = argType${l}['toWireType'](${h}, arg${l});
`),
            c.push(`argType${l}`);
        if (
          ((f +=
...
`;
          ...
          for (l = 2; l < e.length; ++l) {
            var m = l === 1 ? 'thisWired' : 'arg' + (l - 2) + 'Wired';
            e[l].destructorFunction !== null &&
              ((f += `${m}_dtor(${m});
`),
              c.push(`${m}_dtor`));
          }
...
`),
      ...
      function Lr(e, r, t, n, a, i) {
        var s = r.length;
        s < 2 &&
          S("argTypes array size mismatch! Must at least get return value and 'this' types!");
        for (
          var u = r[1] !== null && t !== null,
            l = qe(r),
            f = r[0].name !== 'void',
            h = [e, S, n, a, Ve, r[0], r[1]],
            c = 0;
          c < s - 2;
          ++c
        )
          h.push(r[c + 2]);
        if (!l)
          for (c = 2; c < r.length; ++c)
            r[c].destructorFunction !== null && h.push(r[c].destructorFunction);
        let [m, v] = Ur(r, u, f, i);
        m.push(v);
        var k = Xe(Function, m)(...h);
        return de(e, k);
      }
      var Ge,
        Ke,
        ...
        Ir = (e, r, t) => {
          d.hasOwnProperty(e)
            ? ((t === void 0 ||
                (d[e].overloadTable !== void 0 && d[e].overloadTable[t] !== void 0)) &&
                S(`Cannot register public name '${e}' twice`),
              Hr(d, e, e),
              d[e].overloadTable.hasOwnProperty(t) &&
                S(
        ...
        qr = (e, r, t) => {
          d.hasOwnProperty(e) || Ie('Replacing nonexistent public symbol'),
            d[e].overloadTable !== void 0 && t !== void 0
              ? (d[e].overloadTable[t] = r)
              : ((d[e] = r), (d[e].argCount = t));
        },
        Xr = (e, r, t) => ((e = e.replace(/p/g, 'i')), (0, d['dynCall_' + e])(r, ...t)),
        fe = [],
        Je = (e) => {
          var r = fe[e];
          return r || (e >= fe.length && (fe.length = e + 1), (fe[e] = r = Ge.get(e))), r;
        },
        Gr = (e, r, t = []) => (e.includes('j') ? Xr(e, r, t) : Je(r)(...t)),
        Kr =
          (e, r) =>
          (...t) =>
            Gr(e, r, t),
        Jr = (e, r) => {
          function t() {
            return e.includes('j') ? Kr(e, r) : Je(r);
          }
          e = M(e);
          var n = t();
          return (
            typeof n != 'function' && S(`unknown function pointer with signature ${e}: ${r}`), n
          );
        },
        Qr = (e, r) => {
...
` +
        ...
        Yr = (e, r) => {
          var t = [],
            n = {};
          function a(i) {
            n[i] || I[i] || (le[i] ? le[i].forEach(a) : (t.push(i), (n[i] = !0)));
          }
          throw (r.forEach(a), new Ke(`${e}: ` + t.map(Qe).join([', '])));
        },
        Zr = (e) => {
        ...
        et = (e, r, t, n, a, i, s, u) => {
          ...
          (e = M(e)),
            ...
            Ir(
              e,
              function () {
                Yr(`Cannot call ${e} due to unbound types`, l);
              },
              r - 1,
            ),
            jr([], l, (f) => {
              var h = [f[0], null].concat(f.slice(1));
              return qr(e, Lr(e, h, null, a, i, s), r - 1), [];
            });
        },
        rt = (e, r, t) => {
          switch (r) {
            case 1:
              return t ? (n) => F[n] : (n) => P[n];
            case 2:
              return t ? (n) => Q[n >> 1] : (n) => ie[n >> 1];
            case 4:
              return t ? (n) => E[n >> 2] : (n) => y[n >> 2];
            default:
        ...
        tt = (e, r, t, n, a) => {
          ...
          O(e, {
            ...
            argPackAdvance: V,
            readValueFromPointer: rt(r, t, n !== 0),
            destructorFunction: null,
          });
        },
        nt = (e, r, t) => {
          ...
          function a(i) {
            var s = y[i >> 2],
              u = y[(i + 4) >> 2];
            return new n(F.buffer, u, s);
          }
          O(
            e,
            { name: (t = M(t)), fromWireType: a, argPackAdvance: V, readValueFromPointer: a },
        ...
        Ye = typeof TextDecoder < 'u' ? new TextDecoder() : void 0,
        G = (e, r = 0, t = NaN) => {
          for (var n = r + t, a = r; e[a] && !(a >= n); ) ++a;
          if (a - r > 16 && e.buffer && Ye) return Ye.decode(e.subarray(r, a));
          for (var i = ''; r < a; ) {
            var s = e[r++];
            if (128 & s) {
              var u = 63 & e[r++];
        ...
        ot = (e, r) => {
          O(e, {
            name: (r = M(r)),
            fromWireType(t) {
              for (var n, a = y[t >> 2], i = t + 4, s = i, u = 0; u <= a; ++u) {
                var l = i + u;
                if (u == a || P[l] == 0) {
                  var f = Ze(s, l - s);
                  n === void 0 ? (n = f) : ((n += '\0'), (n += f)), (s = l + 1);
                }
              }
              return B(t), n;
            },
            toWireType(t, n) {
              ...
              var s = Se(4 + a + 1),
                u = s + 4;
              if (((y[s >> 2] = a), i)) Z(n, u, a + 1);
              else if (i)
                for (var l = 0; l < a; ++l) {
                  var f = n.charCodeAt(l);
                  f > 255 && (B(u), S('String has UTF-16 code units that do not fit in 8 bits')),
                    (P[u + l] = f);
                }
              else for (l = 0; l < a; ++l) P[u + l] = n[l];
              return t !== null && t.push(B, s), s;
            },
            argPackAdvance: V,
            readValueFromPointer: be,
        ...
        er = typeof TextDecoder < 'u' ? new TextDecoder('utf-16le') : void 0,
        at = (e, r) => {
          for (var t = e, n = t >> 1, a = n + r / 2; !(n >= a) && ie[n]; ) ++n;
          if ((t = n << 1) - e > 32 && er) return er.decode(P.subarray(e, t));
        ...
        ft = (e, r, t) => {
          ...
          (t = M(t)),
            r === 2
              ? ((n = at), (a = it), (s = st), (i = (u) => ie[u >> 1]))
              : r === 4 && ((n = ut), (a = lt), (s = dt), (i = (u) => y[u >> 2])),
            O(e, {
              name: t,
              fromWireType: (u) => {
                for (var l, f = y[u >> 2], h = u + 4, c = 0; c <= f; ++c) {
                  var m = u + 4 + c * r;
                  if (c == f || i(m) == 0) {
                    var v = n(h, m - h);
                    l === void 0 ? (l = v) : ((l += '\0'), (l += v)), (h = m + r);
                  }
                }
                return B(u), l;
              },
              toWireType: (u, l) => {
                typeof l != 'string' && S(`Cannot pass non-string to C++ string type ${t}`);
                var f = s(l),
                  h = Se(4 + f + r);
                return (y[h >> 2] = f / r), a(l, h + 4, f + r), u !== null && u.push(B, h), h;
              },
              argPackAdvance: V,
              readValueFromPointer: be,
        ...
        ht = (e, r, t) => P.copyWithin(e, r, r + t),
        rr = (e, r) => {
          var t = I[e];
          return t === void 0 && S(`${r} has unknown type ${Qe(e)}`), t;
        },
        tr = (e, r, t) => {
          var n = [],
            a = e.toWireType(n, t);
          return n.length && (y[r >> 2] = D.toHandle(n)), a;
        },
        pt = (e, r, t) => ((e = D.toValue(e)), (r = rr(r, 'emval::as')), tr(r, t, e)),
        ce = [],
        mt = (e, r, t, n) => (e = ce[e])(null, (r = D.toValue(r)), t, n),
        vt = {},
        he = (e) => {
          var r = vt[e];
          return r === void 0 ? M(e) : r;
        },
        wt = (e, r, t, n, a) => (e = ce[e])((r = D.toValue(r)), r[(t = he(t))], n, a),
        nr = () => (typeof globalThis == 'object' ? globalThis : Function('return this')()),
        yt = (e) => (e === 0 ? D.toHandle(nr()) : ((e = he(e)), D.toHandle(nr()[e]))),
        gt = (e) => {
          var r = ce.length;
          return ce.push(e), r;
        },
...
`,
            ...
            u = [];
          t === 0 && u.push('obj');
          for (var l = ['retType'], f = [a], h = 0; h < e; ++h)
            u.push('arg' + h),
              l.push('argType' + h),
              f.push(n[h]),
              (i += `  var arg${h} = argType${h}.readValueFromPointer(args${s ? '+' + s : ''});
`),
              (s += n[h].argPackAdvance);
          (i += `  var rv = ${t === 1 ? 'new func' : 'func.call'}(${u.join(', ')});
`),
            a.isVoid ||
...
`),
            l.push(i);
          var c = Xe(Function, l)(...f),
            m = `methodCaller<(${n.map((v) => v.name).join(', ')}) => ${a.name}>`;
          return gt(de(m, c));
        },
        bt = (e) => ((e = he(e)), D.toHandle(d[e])),
        _t = (e, r) => ((e = D.toValue(e)), (r = D.toValue(r)), D.toHandle(e[r])),
        At = (e) => {
          e > 9 && (W[e + 1] += 1);
        },
        Ft = (e) => D.toHandle(he(e)),
        Pt = (e) => {
          var r = D.toValue(e);
          Ve(r), ke(e);
        },
        Dt = (e, r, t, n) => {
          var a = new Date().getFullYear(),
            ...
            f = Math.max(u, l);
          (y[e >> 2] = 60 * f), (E[r >> 2] = +(u != l));
          var h = (v) => {
              var k = v >= 0 ? '-' : '+',
                b = Math.abs(v);
              return `UTC${k}${String(Math.floor(b / 60)).padStart(2, '0')}${String(b % 60).padStart(2, '0')}`;
            },
            c = h(u),
            m = h(l);
          l < u ? (Z(c, t, 17), Z(m, n, 17)) : (Z(c, n, 17), Z(m, t, 17));
        },
        St = () => 2147483648,
        Tt = (e, r) => Math.ceil(e / r) * r,
        Ct = (e) => {
          var r = ((e - ae.buffer.byteLength + 65535) / 65536) | 0;
          try {
            return ae.grow(r), $e(), 1;
          } catch {}
        },
        Mt = (e) => {
          var r = P.length;
          ...
          for (var n = 1; n <= 4; n *= 2) {
            ...
            var i = Math.min(t, Tt(Math.max(e, a), 65536));
            if (Ct(i)) return !0;
          }
          return !1;
        },
        ...
        Rt = (e, r) => {
          ...
          return (
            ee().forEach((n, a) => {
              var i = r + t;
              (y[(e + 4 * a) >> 2] = i), xt(n, i), (t += n.length + 1);
            }),
            0
          );
        },
        ...
        g = {
          ...
          basename: (e) => {
            if (e === '/') return '/';
            var r = (e = (e = g.normalize(e)).replace(/\/$/, '')).lastIndexOf('/');
        ...
        K = {
          ...
          relative: (e, r) => {
            function t(f) {
              ...
              for (var c = f.length - 1; c >= 0 && f[c] === ''; c--);
              return h > c ? [] : f.slice(h, c - h + 1);
            }
...
`),
        ...
        q = {
          ...
          shutdown() {},
          register(e, r) {
            (q.ttys[e] = { input: [], output: [], ops: r }), o.registerDevice(e, q.stream_ops);
          },
          stream_ops: {
            open(e) {
          ...
          default_tty_ops: {
            ...
            put_char(e, r) {
              r === null || r === 10
                ? (ve(G(e.output)), (e.output = []))
                : r != 0 && e.output.push(r);
            },
            fsync(e) {
              e.output && e.output.length > 0 && (ve(G(e.output)), (e.output = []));
            },
            ioctl_tcgets: (e) => ({
              c_iflag: 25856,
              c_oflag: 5,
          ...
          default_tty1_ops: {
            put_char(e, r) {
              r === null || r === 10
                ? (U(G(e.output)), (e.output = []))
                : r != 0 && e.output.push(r);
            },
            fsync(e) {
              e.output && e.output.length > 0 && (U(G(e.output)), (e.output = []));
            },
          },
        },
        ir = (e) => {
        ...
        p = {
          ops_table: null,
          mount: (e) => p.createNode(null, '/', 16895, 0),
          createNode(e, r, t, n) {
            ...
            p.ops_table ||
              (p.ops_table = {
                ...
                file: {
                  node: { getattr: p.node_ops.getattr, setattr: p.node_ops.setattr },
                  stream: {
            ...
            return (
              o.isDir(a.mode)
                ? ((a.node_ops = p.ops_table.dir.node),
                  (a.stream_ops = p.ops_table.dir.stream),
                  (a.contents = {}))
                : o.isFile(a.mode)
                  ? ((a.node_ops = p.ops_table.file.node),
                    (a.stream_ops = p.ops_table.file.stream),
                    (a.usedBytes = 0),
                    (a.contents = null))
                  : o.isLink(a.mode)
                    ? ((a.node_ops = p.ops_table.link.node),
                      (a.stream_ops = p.ops_table.link.stream))
                    : o.isChrdev(a.mode) &&
                      ((a.node_ops = p.ops_table.chrdev.node),
                      (a.stream_ops = p.ops_table.chrdev.stream)),
          ...
          node_ops: {
            getattr(e) {
              var r = {};
              return (
                (r.dev = o.isChrdev(e.mode) ? e.id : 1),
                (r.ino = e.id),
                (r.mode = e.mode),
                (r.nlink = 1),
                (r.uid = 0),
            ...
            setattr(e, r) {
              for (const t of ['mode', 'atime', 'mtime', 'ctime']) r[t] && (e[t] = r[t]);
              r.size !== void 0 && p.resizeFileStorage(e, r.size);
            },
            lookup(e, r) {
              throw p.doesNotExistError;
            },
            mknod: (e, r, t, n) => p.createNode(e, r, t, n),
            rename(e, r, t) {
              var n;
              try {
                n = o.lookupNode(r, t);
              ...
              if (n) {
                if (o.isDir(e.mode)) for (var a in n.contents) throw new o.ErrnoError(55);
                o.hashRemoveNode(n);
              }
          ...
          stream_ops: {
            read(e, r, t, n, a) {
              ...
              else for (var u = 0; u < s; u++) r[t + u] = i[a + u];
              return s;
            },
            write(e, r, t, n, a, i) {
              ...
              else for (var u = 0; u < n; u++) s.contents[a + u] = r[t + u];
            ...
            llseek(e, r, t) {
              ...
              if (
                (t === 1
                  ? (n += e.position)
                  : t === 2 && o.isFile(e.node.mode) && (n += e.node.usedBytes),
                n < 0)
              )
            ...
            allocate(e, r, t) {
              p.expandFileStorage(e.node, r + t),
            ...
            mmap(e, r, t, n, a) {
              ...
              var i,
                s,
                u = e.node.contents;
              if (2 & a || !u || u.buffer !== F.buffer) {
                if (((s = !0), !(i = ir()))) throw new o.ErrnoError(48);
                u &&
                  ((t > 0 || t + r < u.length) &&
                    (u = u.subarray
                      ? u.subarray(t, t + r)
                      : Array.prototype.slice.call(u, t, t + r)),
                  F.set(u, i));
              } else (s = !1), (i = u.byteOffset);
              return { ptr: i, allocated: s };
            },
            msync: (e, r, t, n, a) => (p.stream_ops.write(e, r, 0, n, t, !1), 0),
          },
        },
        Ot = async (e) => {
          var r = await me(e);
        ...
        Lt = (e, r, t, n, a, i, s, u, l, f) => {
          var h = r ? K.resolve(g.join2(e, r)) : e;
          function c(m) {
            function v(k) {
              f == null || f(), u || Wt(e, r, k, n, a, l), i == null || i(), we();
            }
            Ut(m, h, v, () => {
              s == null || s(), we();
            }) || v(m);
          }
          We(), typeof t == 'string' ? Ot(t).then(c, s) : c(t);
        },
        Ht = (e) => {
        ...
        o = {
          ...
          lookupPath(e, r = {}) {
            ...
            r.follow_mount ?? (r.follow_mount = !0), g.isAbs(e) || (e = o.cwd() + '/' + e);
            e: for (var t = 0; t < 40; t++) {
              for (
                var n = e.split('/').filter((f) => !!f && f !== '.'), a = o.root, i = '/', s = 0;
                s < n.length;
                s++
              ) {
                var u = s === n.length - 1;
                ...
                if (n[s] !== '..') {
                  ...
                  try {
                    ...
                    if ((f == null ? void 0 : f.errno) === 44 && u && r.noent_okay)
                      return { path: i };
                    throw f;
                  }
                  if (
                    (!o.isMountpoint(a) || (u && !r.follow_mount) || (a = a.mounted.root),
                    o.isLink(a.mode) && (!u || r.follow))
                  ) {
                    if (!a.node_ops.readlink) throw new o.ErrnoError(52);
                    var l = a.node_ops.readlink(a);
                    g.isAbs(l) || (l = g.dirname(i) + '/' + l),
                      (e = l + '/' + n.slice(s + 1).join('/'));
                    continue e;
                  }
                } else (i = g.dirname(i)), (a = a.parent);
              }
          ...
          mayOpen: (e, r) =>
            e
              ? o.isLink(e.mode)
                ? 32
                : o.isDir(e.mode) && (o.flagsToPermissionString(r) !== 'r' || 512 & r)
                  ? 31
                  : o.nodePermissions(e, o.flagsToPermissionString(r))
              : 44,
          MAX_OPEN_FDS: 4096,
          nextfd() {
          ...
          mknod(e, r, t) {
            ...
            return n.node_ops.mknod(n, a, r, t);
          },
          statfs(e) {
            var r = {
                bsize: 4096,
              ...
              t = o.lookupPath(e, { follow: !0 }).node;
            return (
              t != null &&
                t.node_ops.statfs &&
          ...
          create: (e, r = 438) => ((r &= 4095), (r |= 32768), o.mknod(e, r, 0)),
          mkdir: (e, r = 511) => ((r &= 1023), (r |= 16384), o.mknod(e, r, 0)),
          mkdirTree(e, r) {
          ...
          mkdev: (e, r, t) => (t === void 0 && ((t = r), (r = 438)), (r |= 8192), o.mknod(e, r, t)),
          symlink(e, r) {
            if (!K.resolve(e)) throw new o.ErrnoError(44);
          ...
          rename(e, r) {
            var t,
              ...
              u = g.basename(r);
            if (
              ((t = o.lookupPath(e, { parent: !0 }).node),
              (n = o.lookupPath(r, { parent: !0 }).node),
              !t || !n)
            )
            ...
            if ((h = K.relative(r, a)).charAt(0) !== '.') throw new o.ErrnoError(55);
            try {
              l = o.lookupNode(n, u);
            } catch {}
            if (f !== l) {
              var c = o.isDir(f.mode),
                m = o.mayDelete(t, s, c);
              if (m) throw new o.ErrnoError(m);
              if ((m = l ? o.mayDelete(n, u, c) : o.mayCreate(n, u))) throw new o.ErrnoError(m);
              if (!t.node_ops.rename) throw new o.ErrnoError(63);
              if (o.isMountpoint(f) || (l && o.isMountpoint(l))) throw new o.ErrnoError(10);
              if (n !== t && (m = o.nodePermissions(t, 'w'))) throw new o.ErrnoError(m);
              o.hashRemoveNode(f);
              try {
                t.node_ops.rename(f, n, u), (f.parent = n);
              } catch (v) {
                throw v;
              } finally {
                o.hashAddNode(f);
          ...
          chmod(e, r, t) {
            var n;
            if (
              !(n = typeof e == 'string' ? o.lookupPath(e, { follow: !t }).node : e).node_ops
                .setattr
            )
              throw new o.ErrnoError(63);
            n.node_ops.setattr(n, { mode: (4095 & r) | (-4096 & n.mode), ctime: Date.now() });
          },
          lchmod(e, r) {
            o.chmod(e, r, !0);
          },
          ...
          truncate(e, r) {
            ...
            var t;
            if (
              !(t = typeof e == 'string' ? o.lookupPath(e, { follow: !0 }).node : e).node_ops
                .setattr
            )
              throw new o.ErrnoError(63);
          ...
          utime(e, r, t) {
            ...
            n.node_ops.setattr(n, { atime: r, mtime: t });
          },
          open(e, r, t = 438) {
            if (e === '') throw new o.ErrnoError(44);
            var n;
            if (
              ((t = 64 & (r = typeof r == 'string' ? Ht(r) : r) ? (4095 & t) | 32768 : 0),
              typeof e == 'object')
            )
              n = e;
            else {
              var a = o.lookupPath(e, { follow: !(131072 & r), noent_okay: !0 });
              (n = a.node), (e = a.path);
            }
            var i = !1;
            if (64 & r)
              if (n) {
                if (128 & r) throw new o.ErrnoError(20);
              } else (n = o.mknod(e, t, 0)), (i = !0);
            if (!n) throw new o.ErrnoError(44);
            if ((o.isChrdev(n.mode) && (r &= -513), 65536 & r && !o.isDir(n.mode)))
              throw new o.ErrnoError(54);
            if (!i) {
              var s = o.mayOpen(n, r);
              if (s) throw new o.ErrnoError(s);
            }
            512 & r && !i && o.truncate(n, 0), (r &= -131713);
            ...
            return (
              ...
              !d.logReadFiles || 1 & r || e in o.readFiles || (o.readFiles[e] = 1),
              u
            );
          },
          close(e) {
          ...
          write(e, r, t, n, a, i) {
            ...
            var u = e.stream_ops.write(e, r, t, n, a, i);
            return s || (e.position += u), u;
          },
          allocate(e, r, t) {
            if (o.isClosed(e)) throw new o.ErrnoError(8);
            if (r < 0 || t <= 0) throw new o.ErrnoError(28);
            if (!(2097155 & e.flags)) throw new o.ErrnoError(8);
          ...
          msync: (e, r, t, n, a) => (e.stream_ops.msync ? e.stream_ops.msync(e, r, t, n, a) : 0),
          ioctl(e, r, t) {
          ...
          readFile(e, r = {}) {
            ...
            return (
              o.read(n, i, 0, a, 0),
              r.encoding === 'utf8' ? (t = G(i)) : r.encoding === 'binary' && (t = i),
              o.close(n),
              t
            );
          },
              ...
              o.mount(
                {
                  mount() {
                    ...
                    return (
                      (r.stream_ops = { llseek: p.stream_ops.llseek }),
                      (r.node_ops = {
                        lookup(t, n) {
                          var a = +n,
          ...
          createStandardStreams(e, r, t) {
            e ? o.createDevice('/dev', 'stdin', e) : o.symlink('/dev/tty', '/dev/stdin'),
              r ? o.createDevice('/dev', 'stdout', null, r) : o.symlink('/dev/tty', '/dev/stdout'),
          ...
          analyzePath(e, r) {
            try {
              e = (n = o.lookupPath(e, { follow: !r })).path;
            } catch {}
            var t = {
              isRoot: !1,
              exists: !1,
          ...
          createFile(e, r, t, n, a) {
            var i = g.join2(typeof e == 'string' ? e : o.getPath(e), r),
              s = De(n, a);
            return o.create(i, s);
          },
          createDataFile(e, r, t, n, a, i) {
            var s = r;
            e && ((e = typeof e == 'string' ? e : o.getPath(e)), (s = r ? g.join2(e, r) : e));
            var u = De(n, a),
              l = o.create(s, u);
            if (t) {
              if (typeof t == 'string') {
                for (var f = new Array(t.length), h = 0, c = t.length; h < c; ++h)
                  f[h] = t.charCodeAt(h);
                t = f;
              }
              o.chmod(l, 146 | u);
              var m = o.open(l, 577);
              o.write(m, t, 0, t.length, 0, i), o.close(m), o.chmod(l, u);
            }
          },
          createDevice(e, r, t, n) {
            var u;
            var a = g.join2(typeof e == 'string' ? e : o.getPath(e), r),
              i = De(!!t, !!n);
            (u = o.createDevice).major ?? (u.major = 64);
              ...
              o.registerDevice(s, {
                ...
                read(l, f, h, c, m) {
                  for (var v = 0, k = 0; k < c; k++) {
                    ...
                    if (b === void 0 && v === 0) throw new o.ErrnoError(6);
                    if (b == null) break;
                    v++, (f[h + k] = b);
                  }
                ...
                write(l, f, h, c, m) {
                  ...
                  return c && (l.node.mtime = l.node.ctime = Date.now()), v;
                },
              }),
              o.mkdev(a, i, s)
            );
          ...
          createLazyFile(e, r, t, n, a) {
            class i {
              ...
              get(c) {
                if (!(c > this.length - 1 || c < 0)) {
                  var m = c % this.chunkSize,
                    v = (c / this.chunkSize) | 0;
                  return this.getter(v)[m];
                }
              }
              setDataGetter(c) {
                this.getter = c;
              ...
              cacheLength() {
                ...
                if (
                  ...
                  throw new Error("Couldn't load " + t + '. Status: ' + c.status);
                var m,
                  v = Number(c.getResponseHeader('Content-length')),
                  k = (m = c.getResponseHeader('Accept-Ranges')) && m === 'bytes',
                  b = (m = c.getResponseHeader('Content-Encoding')) && m === 'gzip',
                  C = 1048576;
                k || (C = v);
                var j = (R, J) => {
                    if (R > J)
                      throw new Error(
                        'invalid range (' + R + ', ' + J + ') or no bytes requested!',
                      );
                    if (J > v - 1)
                    ...
                    if (
                      (A.open('GET', t, !1),
                      v !== C && A.setRequestHeader('Range', 'bytes=' + R + '-' + J),
                      ...
                      throw new Error("Couldn't load " + t + '. Status: ' + A.status);
                ...
                te.setDataGetter((R) => {
                  ...
                  if (
                    ((A = Math.min(A, v - 1)),
                    te.chunks[R] === void 0 && (te.chunks[R] = j(J, A)),
                    te.chunks[R] === void 0)
                  )
            ...
            var l = {};
            function f(h, c, m, v, k) {
              var b = h.node.contents;
              if (k >= b.length) return 0;
              var C = Math.min(b.length - k, v);
              if (b.slice) for (var j = 0; j < C; j++) c[m + j] = b[k + j];
              else for (j = 0; j < C; j++) c[m + j] = b.get(k + j);
              return C;
            }
            return (
              Object.keys(u.stream_ops).forEach((h) => {
                var c = u.stream_ops[h];
                l[h] = (...m) => (o.forceLoadFile(u), c(...m));
              }),
              (l.read = (h, c, m, v, k) => (o.forceLoadFile(u), f(h, c, m, v, k))),
              (l.mmap = (h, c, m, v, k) => {
                o.forceLoadFile(u);
                var b = ir();
                if (!b) throw new o.ErrnoError(48);
                return f(h, F, b, c, m), { ptr: b, allocated: !0 };
              }),
              (u.stream_ops = l),
              u
            );
        ...
        re = {
          ...
          calculateAt(e, r, t) {
            ...
            var n;
            if (((n = e === -100 ? o.cwd() : re.getStreamFromFD(e).path), r.length == 0)) {
              if (!t) throw new o.ErrnoError(44);
              return n;
            }
            return n + '/' + r;
          ...
          doStat(e, r, t) {
            ...
            (E[t >> 2] = n.dev),
              ...
              (_ = [
                ...
                +Math.abs(w) >= 1
                  ? w > 0
                    ? +Math.floor(w / 4294967296) >>> 0
                    : ~~+Math.ceil((w - +(~~w >>> 0)) / 4294967296) >>> 0
                  : 0),
              ]),
              (E[(t + 24) >> 2] = _[0]),
              (E[(t + 28) >> 2] = _[1]),
      ...
      var Xt = (e, r) => ((r + 2097152) >>> 0 < 4194305 - !!e ? (e >>> 0) + 4294967296 * r : NaN);
      function Gt(e, r, t, n, a) {
        var i = Xt(r, t);
        try {
          if (isNaN(i)) return 61;
          var s = re.getStreamFromFD(e);
          return (
            o.llseek(s, i, n),
            (_ = [
              s.position >>> 0,
      ...
      Mr(),
        ...
        Nr(),
        (Ke = d.UnboundTypeError = Qr(Error, 'UnboundTypeError')),
        (o.createPreloadedFile = Lt),
        o.staticInit(),
        (p.doesNotExistError = new o.ErrnoError(44)),
        (p.doesNotExistError.stack = '<generic error, no stack>');
      var T,
        Qt = {
          q: Sr,
          w: Tr,
      ...
      function ur() {
        function e() {
          ...
          pe ||
            ((pe = !0),
            (d.calledRun = !0),
            Re || (pr(), x(d), (r = d.onRuntimeInitialized) == null || r.call(d), mr()));
        }
        H > 0 ||
          (hr(),
          H > 0 ||
      ...
      if (
        ((d.dynCall_jiji = (e, r, t, n, a) => (d.dynCall_jiji = T.M)(e, r, t, n, a)),
        (d.dynCall_viijii = (e, r, t, n, a, i, s) => (d.dynCall_viijii = T.N)(e, r, t, n, a, i, s)),
        (d.dynCall_iiiiij = (e, r, t, n, a, i, s) => (d.dynCall_iiiiij = T.O)(e, r, t, n, a, i, s)),
        (d.dynCall_iiiiijj = (e, r, t, n, a, i, s, u, l) =>
          (d.dynCall_iiiiijj = T.P)(e, r, t, n, a, i, s, u, l)),
        (d.dynCall_iiiiiijj = (e, r, t, n, a, i, s, u, l, f) =>
          (d.dynCall_iiiiiijj = T.Q)(e, r, t, n, a, i, s, u, l, f)),
        (Y = function e() {
          pe || ur(), pe || (Y = e);
        }),
        d.preInit)
