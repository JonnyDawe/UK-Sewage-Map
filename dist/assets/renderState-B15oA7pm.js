import { e as o } from './basicInterfaces-CZwQPxTp.js';
import { ew as c, ex as d, ey as h, ez as s } from './index.lazy-BFilFZ3v.js';
function u(t, e, i = h.ADD, n = [0, 0, 0, 0]) {
  return {
    srcRgb: t,
    srcAlpha: t,
    dstRgb: e,
...
function O(t, e, i, n, _ = h.ADD, w = h.ADD, a = [0, 0, 0, 0]) {
  return {
    srcRgb: t,
    srcAlpha: e,
    dstRgb: i,
...
const J = u(s.ZERO, s.ONE_MINUS_SRC_ALPHA);
u(s.ONE, s.ZERO);
u(s.ONE, s.ONE);
const Q = u(s.ONE, s.ONE_MINUS_SRC_ALPHA),
  V = O(s.SRC_ALPHA, s.ONE, s.ONE_MINUS_SRC_ALPHA, s.ONE_MINUS_SRC_ALPHA),
  A = { face: d.BACK, mode: c.CCW },
  B = { face: d.FRONT, mode: c.CCW },
  X = (t) => (t === o.Back ? A : t === o.Front ? B : null),
  Y = { zNear: 0, zFar: 1 },
  tt = { r: !0, g: !0, b: !0, a: !0 };
function D(t) {
  return z.intern(t);
...
class l {
  constructor(e, i) {
    (this._makeKey = e), (this._makeRef = i), (this._interns = new Map());
  }
  intern(e) {
    if (!e) return null;
    const i = this._makeKey(e),
      n = this._interns;
...
const $ = new l(b, (t) => ({ __tag: 'StencilWrite', ...t }));
function b(t) {
  return t ? r([t.mask]) : null;
}
const x = new l(T, (t) => ({ __tag: 'DrawBuffers', ...t }));
function T(t) {
  return t ? r(t.buffers) : null;
}
const Z = new l(j, (t) => ({
  blending: D(t.blending),
  culling: C(t.culling),
  polygonOffset: R(t.polygonOffset),
  depthTest: y(t.depthTest),
  stencilTest: N(t.stencilTest),
  depthWrite: m(t.depthWrite),
  colorWrite: P(t.colorWrite),
  stencilWrite: E(t.stencilWrite),
  drawBuffers: k(t.drawBuffers),
}));
function j(t) {
  return t
    ? r([
...
class it {
  ...
  setPipeline(e) {
    (this._pipelineInvalid || e !== this._pipeline) &&
      ...
      this._setDrawBuffers(e.drawBuffers),
      (this._pipeline = e)),
  ...
  _setDrawBuffers(e) {
    (this._drawBuffers = this._setSubState(
      e,
      this._drawBuffers,
      this._drawBuffersInvalid,
      this._stateSetters.setDrawBuffers,
    )),
      (this._drawBuffersInvalid = !1);
  }
  _setSubState(e, i, n, _) {
    return (n || e !== i) && (_(e), (this._pipelineInvalid = !0)), e;
  }
}
export { et as B, it as Q, J as a, V as c, X as f, tt as g, Q as o, Y as p, O as r, B as u };
