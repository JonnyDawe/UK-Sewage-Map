const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/CatalogLayer-CmBBYePj.js',
      ...
      'assets/OrientedImageryLayer-B8Wpphis.js',
    ]),
) => i.map((i) => d[i]);
...
import {
  ...
  I as g,
  m as L,
} from './utils-QN2dJcAe.js';
import { t as aa, i as ea } from './fetchService-CIEjin9h.js';
  ...
  a.forEach(({ type: o }) => {
    switch (ea(o)) {
      case 'CatalogLayer':
        e.push(
          I(
            () => import('./CatalogLayer-CmBBYePj.js'),
            __vite__mapDeps([
      ...
      case 'FeatureLayer':
        e.push(
          I(
            () => import('./index.lazy-BHTpPf8X.js').then((s) => s.wa),
      ...
      case 'OrientedImageryLayer':
        e.push(
          I(
            () => import('./OrientedImageryLayer-B8Wpphis.js'),
