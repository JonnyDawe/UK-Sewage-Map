const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      'assets/executeRelationshipQuery-aFpu16N5.js',
      'assets/queryAttachments-CUfHmer6.js',
      'assets/executeAttributeBinsQuery-gQXug_xL.js',
      'assets/AttributeBinsFeatureSet-CUF6bWHg.js',
      'assets/AttributeBinsQuery-DsxUxBMj.js',
      'assets/queryUtils-BQJHb1Wr.js',
      'assets/json-Wa8cmqdu.js',
      'assets/FixedIntervalBinParameters-CKrks9ad.js',
      'assets/executeTopFeaturesQuery-Dtns8D-6.js',
      'assets/queryTopFeatures-CTRWZtOW.js',
      'assets/TopFeaturesQuery-BAUiz4gP.js',
      'assets/executeForTopIds-DZM6nYUc.js',
      'assets/executeForTopExtents-BtYvGy2q.js',
      'assets/executeForTopCount-CCzhkGnb.js',
    ]),
) => i.map((i) => d[i]);
...
import { s as N, a as B } from './executeForIds-DTO8Jv9O.js';
import { M as Z, u as k } from './featureConversionUtils-VaE6vOn5.js';
...
let a = class extends G {
  ...
  async featureSetFromJSON(r, t, e) {
    ...
    const { meshFeatureSetFromJSON: s } = await l(
      n(
        () => import('./meshFeatureSet-D8fo9TIv.js'),
        __vite__mapDeps([
  ...
  async executeRelationshipQuery(r, t) {
    const [{ default: e }, { executeRelationshipQuery: s }] = await l(
      Promise.all([
        n(
          () => import('./index.lazy-BHTpPf8X.js').then((o) => o.w9),
          __vite__mapDeps([1, 2, 3, 4]),
        ),
        n(
          () => import('./executeRelationshipQuery-aFpu16N5.js'),
  ...
  async executeAttachmentQuery(r, t) {
    const {
        ...
        n(() => import('./queryAttachments-CUfHmer6.js'), __vite__mapDeps([32, 1, 2, 3, 4])),
        t,
      ),
      i = m(this.url);
  ...
  async executeAttributeBinsQuery(r, t) {
    const { executeAttributeBinsQuery: e } = await l(
      n(
        () => import('./executeAttributeBinsQuery-gQXug_xL.js'),
  ...
  async executeTopFeaturesQuery(r, t) {
    const { executeTopFeaturesQuery: e } = await l(
      n(
        () => import('./executeTopFeaturesQuery-Dtns8D-6.js'),
  ...
  async executeForTopIds(r, t) {
    const { executeForTopIds: e } = await l(
      n(() => import('./executeForTopIds-DZM6nYUc.js'), __vite__mapDeps([42, 1, 2, 3, 4, 40, 41])),
      t,
    );
    return e(this.parsedUrl, r, t);
  }
  async executeForTopExtents(r, t) {
    const { executeForTopExtents: e } = await l(
      n(
        () => import('./executeForTopExtents-BtYvGy2q.js'),
  ...
  async executeForTopCount(r, t) {
    const { executeForTopCount: e } = await l(
      n(
        () => import('./executeForTopCount-CCzhkGnb.js'),
