import { o as An } from './_commonjsHelpers-DCkdB7M8.js';
var K,
  Q = { exports: {} };
function Rn() {
  return (
    K ||
      ((K = 1),
      (D = Q),
      (R = typeof document < 'u' && document.currentScript ? document.currentScript.src : void 0),
      (W = function (n) {
        var H, S;
        ...
        var M,
          ...
          O,
          U = !1,
          B = typeof TextDecoder < 'u' ? new TextDecoder('utf8') : void 0;
        function Z(e, t, i) {
        ...
        var p = 0,
          y = null;
        function an(e) {
          p++, n.monitorRunDependencies && n.monitorRunDependencies(p);
        }
        function sn(e) {
          if ((p--, n.monitorRunDependencies && n.monitorRunDependencies(p), p == 0 && y)) {
            var t = y;
            (y = null), t();
          }
        }
        ...
        function fn() {
          return m || (!C && !v) || typeof fetch != 'function'
        ...
        function ln() {
          ...
          function u() {
            return m ||
              ...
              ? c(i)
              : fetch(a, { credentials: 'same-origin' }).then(function (o) {
        ...
        function pn(e, t, i, c) {
          g(
            'Assertion failed: ' +
              P(e) +
              ', at: ' +
              [t ? P(t) : 'unknown filename', i, c ? P(c) : 'unknown function'],
          );
        }
        function hn(e) {
          return X(e + 24) + 24;
        ...
        function mn(e) {
          (this.excPtr = e),
            ...
            (this.get_exception_ptr = function () {
              if (Y(this.get_type())) return l[this.excPtr >> 2];
        ...
        function bn(e) {
          ...
          for (var u = 1; u <= 4; u *= 2) {
            var o = t * (1 + 0.2 / u);
            if (((o = Math.min(o, e + 100663296)), vn(Math.min(i, c(Math.max(e, o), 65536)))))
              return !0;
          }
          return !1;
        }
        var wn = { a: pn, c: hn, b: dn, d: _n, f: yn, e: bn };
        ln(),
        ...
        var A,
          Y = (n.___cxa_is_pointer_type = function () {
        ...
        function j(e) {
          function t() {
            A ||
              ((A = !0),
              (n.calledRun = !0),
              U || (en(), H(n), n.onRuntimeInitialized && n.onRuntimeInitialized(), tn()));
          }
          p > 0 ||
            (nn(),
            p > 0 ||
...
const Sn = An(Rn()),
  xn = Object.freeze(
    Object.defineProperty({ __proto__: null, default: Sn }, Symbol.toStringTag, {
      value: 'Module',
    }),
  );
export { xn as l };
