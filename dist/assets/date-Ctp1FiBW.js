...
function m(t) {
  ...
  return b(n, t)
    ? Number.isNaN(n.getTime())
      ? null
      : n.getTime() - 6e4 * n.getTimezoneOffset()
    : null;
}
function d(t) {
  const n = g.exec(t);
  if (!(n != null && n.groups)) return null;
  const e = n.groups,
    u = +e.year,
    r = +e.month - 1,
    s = +e.day,
  ...
  const a = e.ms ?? '0',
    c = a ? +a.padEnd(3, '0').slice(0, 3) : 0;
  let o;
  if (e.isUTC || !e.offsetSign) o = Date.UTC(u, r, s, i, f, l, c);
  else {
    const N = +e.offsetHours,
      T = +e.offsetMinutes;
    o = 6e4 * (e.offsetSign === '+' ? -1 : 1) * (60 * N + T) + Date.UTC(u, r, s, i, f, l, c);
  }
...
const y =
  ...
  h = !Number.isNaN(new Date('technology 10').getTime());
export { p as e, D as n, C as t };
