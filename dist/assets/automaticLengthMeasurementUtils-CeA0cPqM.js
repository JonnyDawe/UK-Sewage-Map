const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      'assets/index-Dg422aom.js',
      'assets/dynamicClasses-Dlk4kLaw.js',
      'assets/index-750fRHbR.js',
      'assets/resources6-C-XXGpuo.js',
      'assets/index-CmFUGrYK.js',
    ]),
) => i.map((i) => d[i]);
import {
  aZ as xe,
...
import { N as _n } from './MeshTransform-B6wPxgq-.js';
import { t as ue } from './meshVertexSpaceUtils-BhxP4Ndr.js';
import { X as ht, a3 as P, a4 as gn } from './SketchOptions-B_OdQfgz.js';
import { _ as x } from './index-DqxZnyqH.js';
import { t as $n } from './memoize-DmxaQ-k8.js';
import { n as lt } from './projectVectorToVector-BxN8sKqR.js';
import { w as yn, a as bn } from './spatialReferenceEllipsoidUtils-Dh_5G9X2.js';
import { f as wn, u as xn, m as kn } from './geodesicLengthMeasurementUtils-B1sTbkrn.js';
function Zt(t) {
  var o, s;
  const e = 'metric';
  if (t == null) return e;
...
let d = class extends Y {
  ...
  loadDependencies() {
    return Ot({
      button: () =>
        x(
          () => import('./index.lazy-BHTpPf8X.js').then((t) => t.wf),
          __vite__mapDeps([0, 1, 2, 3]),
        ),
      icon: () =>
        x(
          () => import('./index.lazy-BHTpPf8X.js').then((t) => t.we),
          __vite__mapDeps([0, 1, 2, 3]),
        ),
      input: () =>
        x(
          () => import('./index-C8TmRuL7.js').then((t) => t.i),
...
let g = class extends Y {
  ...
  loadDependencies() {
    return Ot({
      button: () =>
        x(
          () => import('./index.lazy-BHTpPf8X.js').then((e) => e.wf),
          __vite__mapDeps([0, 1, 2, 3]),
        ),
      icon: () =>
        x(
          () => import('./index.lazy-BHTpPf8X.js').then((e) => e.we),
          __vite__mapDeps([0, 1, 2, 3]),
        ),
      input: () =>
        x(
          () => import('./index-C8TmRuL7.js').then((e) => e.i),
          __vite__mapDeps([4, 0, 1, 2, 3, 5, 6]),
        ),
      'input-message': () =>
        x(() => import('./index-BXhxFG7-.js'), __vite__mapDeps([5, 0, 1, 2, 3])),
    });
  }
  render() {
...
let R = class extends Y {
  ...
  loadDependencies() {
    return Ot({
      ...
      dropdown: () =>
        x(() => import('./index-Dg422aom.js'), __vite__mapDeps([7, 0, 1, 2, 3, 6, 8])),
      'dropdown-item': () =>
        x(() => import('./index-750fRHbR.js'), __vite__mapDeps([9, 0, 1, 2, 3, 10])),
      'dropdown-group': () =>
        x(() => import('./index-CmFUGrYK.js'), __vite__mapDeps([11, 0, 1, 2, 3, 10])),
    });
  }
  _isElementVisible(t) {
    var e;
