const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      'assets/ElevationQuery-Cha1AOYJ.js',
...
import { p as E } from './ArcGISCachedService-mLqKJeQ9.js';
import { h as O } from './WorkerHandle-CqUuhb7p.js';
import './TileInfoTilemapCache-BbAiJ25G.js';
import './TilemapCache-ByBTRlGD.js';
class N {
  constructor(e, t, i, l) {
...
let s = class extends E(_(g(w(V($))))) {
  ...
  async queryElevation(a, e) {
    const { ElevationQuery: t } = await d(
      () => import('./ElevationQuery-Cha1AOYJ.js'),
