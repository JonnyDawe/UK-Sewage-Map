import { jh as d, W as c, dq as p, hs as f, ji as m, jj as _ } from './index.lazy-BFilFZ3v.js';
import { x as y, w as g, d as P } from './dehydratedFeatures-BPTFaWS4.js';
import { M as C, u as b } from './featureConversionUtils-GdT3zBJg.js';
...
function h(i, t, e, s) {
  switch (e) {
    case 0:
      return a(i, t + s, 0);
    case 1:
      return i.originPosition === 'lowerLeft' ? a(i, t + s, 1) : v(i, t + s, 1);
  }
}
function u(i, t, e, s) {
  return e === 2 ? a(i, t, 2) : h(i, t, e, s);
}
function A(i, t, e, s) {
  return e === 2 ? a(i, t, 3) : h(i, t, e, s);
}
function M(i, t, e, s) {
  return e === 3 ? a(i, t, 3) : u(i, t, e, s);
}
function a({ translate: i, scale: t }, e, s) {
  return i[s] + e * t[s];
}
function v({ translate: i, scale: t }, e, s) {
  return i[s] - e * t[s];
}
class x {
  constructor(t) {
  ...
  addFeature(t, e) {
    const s = this._options.maxStringAttributeLength,
      r = this._options.maxStringAttributeFields;
    g(e.attributes, r, s, (n) => {
  ...
  addQueryGeometry(t, e) {
    const { queryGeometry: s, queryGeometryType: r } = e,
      n = this._transform ? C(s.clone(), s, !1, !1, this._transform) : s.clone(),
      o = b(n, r, !1, !1);
    switch (r) {
    ...
    (t.queryGeometryType = r), (t.queryGeometry = o);
  }
  prepareFeatures(t) {
    switch (
      ((this._transform = t.transform ?? null),
      ...
      case 'point':
        (this.addCoordinate = (e, s, r) => this.addCoordinatePoint(e, s, r)),
          (this.createGeometry = (e) => this.createPointGeometry(e));
        break;
      case 'polygon':
        (this.addCoordinate = (e, s, r) => this._addCoordinatePolygon(e, s, r)),
          (this.createGeometry = (e) => this._createPolygonGeometry(e));
        break;
      case 'polyline':
        (this.addCoordinate = (e, s, r) => this._addCoordinatePolyline(e, s, r)),
          (this.createGeometry = (e) => this._createPolylineGeometry(e));
        break;
      case 'multipoint':
        (this.addCoordinate = (e, s, r) => this._addCoordinateMultipoint(e, s, r)),
  ...
  createFeature() {
    return (
      ...
      new P(m(), null, new this._attributesConstructor())
    );
  }
  allocateCoordinates() {
    const t = this._lengths.reduce((e, s) => e + s, 0);
    (this._coordinateBuffer = new Float64Array(t * this._vertexDimension)),
      (this._coordinateBufferPtr = 0);
  }
  addLength(t, e) {
  ...
  _transformPathLikeValue(t, e) {
    ...
    return (
      ...
      this._transform ? this._applyTransform(this._transform, t, e, s) : t
    );
  }
  ...
  _dehydratedAddPointsCoordinate(t, e, s) {
    ...
    const r = this._transformPathLikeValue(e, s),
      n = t[t.length - 1],
      o = this._coordinateBuffer;
    if (o) {
      if (s === 0) {
        const l = this._coordinateBufferPtr * Float64Array.BYTES_PER_ELEMENT;
        n.push(new Float64Array(o.buffer, l, this._vertexDimension));
      }
  ...
  _deriveApplyTransform(t) {
    ...
    return e && s ? M : e ? u : s ? A : h;
  }
}
class R {
  _parseFeatureQuery(t) {
    var n;
    const e = new x(t.options),
      s = _(t.buffer, e),
      r = {
        ...s,
        spatialReference: (n = s.spatialReference) == null ? void 0 : n.toJSON(),
        fields: s.fields ? s.fields.map((o) => o.toJSON()) : void 0,
